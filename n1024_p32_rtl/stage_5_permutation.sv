...
module s5_ctrl_rom_dp32_st0_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module s5_switch_ctrl_dp32_st0_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s5_ctrl_rom_dp32_st0_per0L s5_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module s5_ctrl_rom_dp32_st1_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module s5_switch_ctrl_dp32_st1_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s5_ctrl_rom_dp32_st1_per0L s5_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module s5_ctrl_rom_dp32_st2_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module s5_switch_ctrl_dp32_st2_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s5_ctrl_rom_dp32_st2_per0L s5_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module s5_ctrl_rom_dp32_st3_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module s5_switch_ctrl_dp32_st3_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s5_ctrl_rom_dp32_st3_per0L s5_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module s5_ctrl_rom_dp32_st4_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module s5_switch_ctrl_dp32_st4_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s5_ctrl_rom_dp32_st4_per0L s5_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
rst                              
  ...
  s5_wireCon_dp32_st0_L wire_stage_0(
  ...
  s5_switch_ctrl_dp32_st0_per0L s5_switch_ctrl_stage_0(.in_start(in_start_stage0),.ctrl_out(wire_ctrl_stage0),.clk(clk), .rst(rst));
  ...
  s5_wireCon_dp32_st1_L wire_stage_1(
  ...
  s5_switch_ctrl_dp32_st1_per0L s5_switch_ctrl_stage_1(.in_start(in_start_stage1),.ctrl_out(wire_ctrl_stage1),.clk(clk), .rst(rst));
  ...
  s5_wireCon_dp32_st2_L wire_stage_2(
  ...
  s5_switch_ctrl_dp32_st2_per0L s5_switch_ctrl_stage_2(.in_start(in_start_stage2),.ctrl_out(wire_ctrl_stage2),.clk(clk), .rst(rst));
  ...
  s5_wireCon_dp32_st3_L wire_stage_3(
  ...
  s5_switch_ctrl_dp32_st3_per0L s5_switch_ctrl_stage_3(.in_start(in_start_stage3),.ctrl_out(wire_ctrl_stage3),.clk(clk), .rst(rst));
  ...
  s5_wireCon_dp32_st4_L wire_stage_4(
  ...
  s5_switch_ctrl_dp32_st4_per0L s5_switch_ctrl_stage_4(.in_start(in_start_stage4),.ctrl_out(wire_ctrl_stage4),.clk(clk), .rst(rst));
...
module s5_ctrl_rom_dp32_st0_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module s5_switch_ctrl_dp32_st0_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s5_ctrl_rom_dp32_st0_per0R s5_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module s5_ctrl_rom_dp32_st1_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module s5_switch_ctrl_dp32_st1_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s5_ctrl_rom_dp32_st1_per0R s5_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module s5_ctrl_rom_dp32_st2_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module s5_switch_ctrl_dp32_st2_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s5_ctrl_rom_dp32_st2_per0R s5_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module s5_ctrl_rom_dp32_st3_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module s5_switch_ctrl_dp32_st3_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s5_ctrl_rom_dp32_st3_per0R s5_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module s5_ctrl_rom_dp32_st4_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module s5_switch_ctrl_dp32_st4_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s5_ctrl_rom_dp32_st4_per0R s5_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
rst                              
  ...
  s5_wireCon_dp32_st4_R wire_stage_4(
        .inData_0(wireIn[0]), .inData_1(wireIn[1]), .inData_2(wireIn[2]), .inData_3(wireIn[3]), .inData_4(wireIn[4]), .inData_5(wireIn[5]), .inData_6(wireIn[6]), .inData_7(wireIn[7]), .inData_8(wireIn[8]), .inData_9(wireIn[9]), .inData_10(wireIn[10]), .inData_11(wireIn[11]), .inData_12(wireIn[12]), .inData_13(wireIn[13]), .inData_14(wireIn[14]), .inData_15(wireIn[15]), .inData_16(wireIn[16]), .inData_17(wireIn[17]), .inData_18(wireIn[18]), .inData_19(wireIn[19]), .inData_20(wireIn[20]), .inData_21(wireIn[21]), .inData_22(wireIn[22]), .inData_23(wireIn[23]), .inData_24(wireIn[24]), .inData_25(wireIn[25]), .inData_26(wireIn[26]), .inData_27(wireIn[27]), .inData_28(wireIn[28]), .inData_29(wireIn[29]), .inData_30(wireIn[30]), .inData_31(wireIn[31]), 
  ...
  s5_switch_ctrl_dp32_st4_per0R s5_switch_ctrl_stage_4(.in_start(con_in_start_stage4),.ctrl_out(wire_ctrl_stage4),.clk(clk), .rst(rst));
  ...
  s5_wireCon_dp32_st3_R wire_stage_3(
  ...
  s5_switch_ctrl_dp32_st3_per0R s5_switch_ctrl_stage_3(.in_start(con_in_start_stage3),.ctrl_out(wire_ctrl_stage3),.clk(clk), .rst(rst));
  ...
  s5_wireCon_dp32_st2_R wire_stage_2(
  ...
  s5_switch_ctrl_dp32_st2_per0R s5_switch_ctrl_stage_2(.in_start(con_in_start_stage2),.ctrl_out(wire_ctrl_stage2),.clk(clk), .rst(rst));
  ...
  s5_wireCon_dp32_st1_R wire_stage_1(
  ...
  s5_switch_ctrl_dp32_st1_per0R s5_switch_ctrl_stage_1(.in_start(con_in_start_stage1),.ctrl_out(wire_ctrl_stage1),.clk(clk), .rst(rst));
  ...
  s5_wireCon_dp32_st0_R wire_stage_0(
  ...
  s5_switch_ctrl_dp32_st0_per0R s5_switch_ctrl_stage_0(.in_start(con_in_start_stage0),.ctrl_out(wire_ctrl_stage0),.clk(clk), .rst(rst));
    ...
    if(rst) begin                    
      ...
      if (en)                           
        case(addr)                        
          ...
          5'b01100: data <= 5'b10010; 
          5'b01101: data <= 5'b10110; 
          5'b01110: data <= 5'b11010; 
          5'b01111: data <= 5'b11110; 
          5'b10000: data <= 5'b00001; 
          5'b10001: data <= 5'b00101; 
          5'b10010: data <= 5'b01001; 
          5'b10011: data <= 5'b01101; 
          5'b10100: data <= 5'b10001; 
          5'b10101: data <= 5'b10101; 
          5'b10110: data <= 5'b11001; 
...
data                             
  ...
  begin                            
    if(rst) begin                    
      ...
      if (en)                           
        case(addr)                        
          5'b00000: data <= 5'b00010; 
          5'b00001: data <= 5'b00110; 
          5'b00010: data <= 5'b01010; 
          5'b00011: data <= 5'b01110; 
          5'b00100: data <= 5'b10010; 
          5'b00101: data <= 5'b10110; 
          5'b00110: data <= 5'b11010; 
          5'b00111: data <= 5'b11110; 
          5'b01000: data <= 5'b00000; 
          5'b01001: data <= 5'b00100; 
          5'b01010: data <= 5'b01000; 
          5'b01011: data <= 5'b01100; 
          5'b01100: data <= 5'b10000; 
          5'b01101: data <= 5'b10100; 
          5'b01110: data <= 5'b11000; 
          5'b01111: data <= 5'b11100; 
          5'b10000: data <= 5'b00011; 
          5'b10001: data <= 5'b00111; 
          5'b10010: data <= 5'b01011; 
          5'b10011: data <= 5'b01111; 
          5'b10100: data <= 5'b10011; 
          5'b10101: data <= 5'b10111; 
          5'b10110: data <= 5'b11011; 
          5'b10111: data <= 5'b11111; 
          5'b11000: data <= 5'b00001; 
          5'b11001: data <= 5'b00101; 
          5'b11010: data <= 5'b01001; 
          5'b11011: data <= 5'b01101; 
          5'b11100: data <= 5'b10001; 
          5'b11101: data <= 5'b10101; 
          5'b11110: data <= 5'b11001; 
          5'b11111: data <= 5'b11101; 
          default: data <= 5'b0; 
        endcase
    end
  end                              
    ...
    if(rst) begin                    
      ...
      if (en)                           
        case(addr)                        
          ...
          5'b01001: data <= 5'b10110; 
          5'b01010: data <= 5'b11010; 
          5'b01011: data <= 5'b11110; 
          5'b01100: data <= 5'b00010; 
          5'b01101: data <= 5'b00110; 
          5'b01110: data <= 5'b01010; 
          5'b01111: data <= 5'b01110; 
          5'b10000: data <= 5'b10001; 
          5'b10001: data <= 5'b10101; 
          5'b10010: data <= 5'b11001; 
          5'b10011: data <= 5'b11101; 
          5'b10100: data <= 5'b00001; 
          5'b10101: data <= 5'b00101; 
          5'b10110: data <= 5'b01001; 
...
data                             
  ...
  begin                            
    if(rst) begin                    
      ...
      if (en)                           
        case(addr)                        
          5'b00000: data <= 5'b10010; 
          5'b00001: data <= 5'b10110; 
          5'b00010: data <= 5'b11010; 
          5'b00011: data <= 5'b11110; 
          5'b00100: data <= 5'b00010; 
          5'b00101: data <= 5'b00110; 
          5'b00110: data <= 5'b01010; 
          5'b00111: data <= 5'b01110; 
          5'b01000: data <= 5'b10000; 
          5'b01001: data <= 5'b10100; 
          5'b01010: data <= 5'b11000; 
          5'b01011: data <= 5'b11100; 
          5'b01100: data <= 5'b00000; 
          5'b01101: data <= 5'b00100; 
          5'b01110: data <= 5'b01000; 
          5'b01111: data <= 5'b01100; 
          5'b10000: data <= 5'b10011; 
          5'b10001: data <= 5'b10111; 
          5'b10010: data <= 5'b11011; 
          5'b10011: data <= 5'b11111; 
          5'b10100: data <= 5'b00011; 
          5'b10101: data <= 5'b00111; 
          5'b10110: data <= 5'b01011; 
          5'b10111: data <= 5'b01111; 
          5'b11000: data <= 5'b10001; 
          5'b11001: data <= 5'b10101; 
          5'b11010: data <= 5'b11001; 
          5'b11011: data <= 5'b11101; 
          5'b11100: data <= 5'b00001; 
          5'b11101: data <= 5'b00101; 
          5'b11110: data <= 5'b01001; 
          5'b11111: data <= 5'b01101; 
          default: data <= 5'b0; 
        endcase
    end
  end                              
    ...
    if(rst) begin                    
      ...
      if (en)                           
        case(addr)                        
          ...
          5'b01001: data <= 5'b01110; 
          5'b01010: data <= 5'b00010; 
          5'b01011: data <= 5'b00110; 
          5'b01100: data <= 5'b11010; 
          5'b01101: data <= 5'b11110; 
          5'b01110: data <= 5'b10010; 
          5'b01111: data <= 5'b10110; 
          5'b10000: data <= 5'b01001; 
          5'b10001: data <= 5'b01101; 
          5'b10010: data <= 5'b00001; 
          5'b10011: data <= 5'b00101; 
          5'b10100: data <= 5'b11001; 
          5'b10101: data <= 5'b11101; 
          5'b10110: data <= 5'b10001; 
    ...
    if(rst) begin                    
      ...
      if (en)                           
        case(addr)                        
          ...
          5'b00100: data <= 5'b11010; 
          5'b00101: data <= 5'b11110; 
          5'b00110: data <= 5'b10010; 
          5'b00111: data <= 5'b10110; 
          5'b01000: data <= 5'b01000; 
          5'b01001: data <= 5'b01100; 
          5'b01010: data <= 5'b00000; 
          5'b01011: data <= 5'b00100; 
          5'b01100: data <= 5'b11000; 
          5'b01101: data <= 5'b11100; 
          5'b01110: data <= 5'b10000; 
          5'b01111: data <= 5'b10100; 
          5'b10000: data <= 5'b01011; 
          5'b10001: data <= 5'b01111; 
          5'b10010: data <= 5'b00011; 
          5'b10011: data <= 5'b00111; 
          5'b10100: data <= 5'b11011; 
          5'b10101: data <= 5'b11111; 
          5'b10110: data <= 5'b10011; 
          5'b10111: data <= 5'b10111; 
          5'b11000: data <= 5'b01001; 
          5'b11001: data <= 5'b01101; 
          5'b11010: data <= 5'b00001; 
          5'b11011: data <= 5'b00101; 
          5'b11100: data <= 5'b11001; 
          5'b11101: data <= 5'b11101; 
          5'b11110: data <= 5'b10001; 
          5'b11111: data <= 5'b10101; 
          default: data <= 5'b0; 
        endcase
    end
  end                              
    ...
    if(rst) begin                    
      ...
      if (en)                           
        case(addr)                        
          ...
          5'b01001: data <= 5'b11110; 
          5'b01010: data <= 5'b10010; 
          5'b01011: data <= 5'b10110; 
          5'b01100: data <= 5'b01010; 
          5'b01101: data <= 5'b01110; 
          5'b01110: data <= 5'b00010; 
          5'b01111: data <= 5'b00110; 
          5'b10000: data <= 5'b11001; 
          5'b10001: data <= 5'b11101; 
          5'b10010: data <= 5'b10001; 
          5'b10011: data <= 5'b10101; 
          5'b10100: data <= 5'b01001; 
          5'b10101: data <= 5'b01101; 
          5'b10110: data <= 5'b00001; 
...
data                             
  ...
  begin                            
    if(rst) begin                    
      ...
      if (en)                           
        case(addr)                        
          5'b00000: data <= 5'b11010; 
          5'b00001: data <= 5'b11110; 
          5'b00010: data <= 5'b10010; 
          5'b00011: data <= 5'b10110; 
          5'b00100: data <= 5'b01010; 
          5'b00101: data <= 5'b01110; 
          5'b00110: data <= 5'b00010; 
          5'b00111: data <= 5'b00110; 
          5'b01000: data <= 5'b11000; 
          5'b01001: data <= 5'b11100; 
          5'b01010: data <= 5'b10000; 
          5'b01011: data <= 5'b10100; 
          5'b01100: data <= 5'b01000; 
          5'b01101: data <= 5'b01100; 
          5'b01110: data <= 5'b00000; 
          5'b01111: data <= 5'b00100; 
          5'b10000: data <= 5'b11011; 
          5'b10001: data <= 5'b11111; 
          5'b10010: data <= 5'b10011; 
          5'b10011: data <= 5'b10111; 
          5'b10100: data <= 5'b01011; 
          5'b10101: data <= 5'b01111; 
          5'b10110: data <= 5'b00011; 
          5'b10111: data <= 5'b00111; 
          5'b11000: data <= 5'b11001; 
          5'b11001: data <= 5'b11101; 
          5'b11010: data <= 5'b10001; 
          5'b11011: data <= 5'b10101; 
          5'b11100: data <= 5'b01001; 
          5'b11101: data <= 5'b01101; 
          5'b11110: data <= 5'b00001; 
          5'b11111: data <= 5'b00101; 
          default: data <= 5'b0; 
        endcase
    end
  end                              
    ...
    if(rst) begin                    
      ...
      if (en)                           
        case(addr)                        
          ...
          5'b01000: data <= 5'b00110; 
          5'b01001: data <= 5'b00010; 
          5'b01010: data <= 5'b01110; 
          5'b01011: data <= 5'b01010; 
          5'b01100: data <= 5'b10110; 
          5'b01101: data <= 5'b10010; 
          5'b01110: data <= 5'b11110; 
          5'b01111: data <= 5'b11010; 
          5'b10000: data <= 5'b00101; 
          5'b10001: data <= 5'b00001; 
          5'b10010: data <= 5'b01101; 
          5'b10011: data <= 5'b01001; 
          5'b10100: data <= 5'b10101; 
          5'b10101: data <= 5'b10001; 
          5'b10110: data <= 5'b11101; 
          5'b10111: data <= 5'b11001; 
...
data                             
  ...
  begin                            
    if(rst) begin                    
      ...
      if (en)                           
        case(addr)                        
          5'b00000: data <= 5'b00110; 
          5'b00001: data <= 5'b00010; 
          5'b00010: data <= 5'b01110; 
          5'b00011: data <= 5'b01010; 
          5'b00100: data <= 5'b10110; 
          5'b00101: data <= 5'b10010; 
          5'b00110: data <= 5'b11110; 
          5'b00111: data <= 5'b11010; 
          5'b01000: data <= 5'b00100; 
          5'b01001: data <= 5'b00000; 
          5'b01010: data <= 5'b01100; 
          5'b01011: data <= 5'b01000; 
          5'b01100: data <= 5'b10100; 
          5'b01101: data <= 5'b10000; 
          5'b01110: data <= 5'b11100; 
          5'b01111: data <= 5'b11000; 
          5'b10000: data <= 5'b00111; 
          5'b10001: data <= 5'b00011; 
          5'b10010: data <= 5'b01111; 
          5'b10011: data <= 5'b01011; 
          5'b10100: data <= 5'b10111; 
          5'b10101: data <= 5'b10011; 
          5'b10110: data <= 5'b11111; 
          5'b10111: data <= 5'b11011; 
          5'b11000: data <= 5'b00101; 
          5'b11001: data <= 5'b00001; 
          5'b11010: data <= 5'b01101; 
          5'b11011: data <= 5'b01001; 
          5'b11100: data <= 5'b10101; 
          5'b11101: data <= 5'b10001; 
          5'b11110: data <= 5'b11101; 
          5'b11111: data <= 5'b11001; 
          default: data <= 5'b0; 
        endcase
    end
  end                              
...
data                             
  ...
  begin                            
    if(rst) begin                    
      ...
      if (en)                           
        case(addr)                        
          5'b00000: data <= 5'b10110; 
          5'b00001: data <= 5'b10010; 
          5'b00010: data <= 5'b11110; 
          5'b00011: data <= 5'b11010; 
          5'b00100: data <= 5'b00110; 
          5'b00101: data <= 5'b00010; 
          5'b00110: data <= 5'b01110; 
          5'b00111: data <= 5'b01010; 
          5'b01000: data <= 5'b10100; 
          5'b01001: data <= 5'b10000; 
          5'b01010: data <= 5'b11100; 
          5'b01011: data <= 5'b11000; 
          5'b01100: data <= 5'b00100; 
          5'b01101: data <= 5'b00000; 
          5'b01110: data <= 5'b01100; 
          5'b01111: data <= 5'b01000; 
          5'b10000: data <= 5'b10111; 
          5'b10001: data <= 5'b10011; 
          5'b10010: data <= 5'b11111; 
          5'b10011: data <= 5'b11011; 
          5'b10100: data <= 5'b00111; 
          5'b10101: data <= 5'b00011; 
          5'b10110: data <= 5'b01111; 
          5'b10111: data <= 5'b01011; 
          5'b11000: data <= 5'b10101; 
          5'b11001: data <= 5'b10001; 
          5'b11010: data <= 5'b11101; 
          5'b11011: data <= 5'b11001; 
          5'b11100: data <= 5'b00101; 
          5'b11101: data <= 5'b00001; 
          5'b11110: data <= 5'b01101; 
          5'b11111: data <= 5'b01001; 
          default: data <= 5'b0; 
        endcase
    end
  end                              
    ...
    if(rst) begin                    
      ...
      if (en)                           
        case(addr)                        
          ...
          5'b01000: data <= 5'b01110; 
          5'b01001: data <= 5'b01010; 
          5'b01010: data <= 5'b00110; 
          5'b01011: data <= 5'b00010; 
          5'b01100: data <= 5'b11110; 
          5'b01101: data <= 5'b11010; 
          5'b01110: data <= 5'b10110; 
          5'b01111: data <= 5'b10010; 
          5'b10000: data <= 5'b01101; 
          5'b10001: data <= 5'b01001; 
          5'b10010: data <= 5'b00101; 
          5'b10011: data <= 5'b00001; 
          5'b10100: data <= 5'b11101; 
          5'b10101: data <= 5'b11001; 
          5'b10110: data <= 5'b10101; 
          5'b10111: data <= 5'b10001; 
...
data                             
  ...
  begin                            
    if(rst) begin                    
      ...
      if (en)                           
        case(addr)                        
          5'b00000: data <= 5'b01110; 
          5'b00001: data <= 5'b01010; 
          5'b00010: data <= 5'b00110; 
          5'b00011: data <= 5'b00010; 
          5'b00100: data <= 5'b11110; 
          5'b00101: data <= 5'b11010; 
          5'b00110: data <= 5'b10110; 
          5'b00111: data <= 5'b10010; 
          5'b01000: data <= 5'b01100; 
          5'b01001: data <= 5'b01000; 
          5'b01010: data <= 5'b00100; 
          5'b01011: data <= 5'b00000; 
          5'b01100: data <= 5'b11100; 
          5'b01101: data <= 5'b11000; 
          5'b01110: data <= 5'b10100; 
          5'b01111: data <= 5'b10000; 
          5'b10000: data <= 5'b01111; 
          5'b10001: data <= 5'b01011; 
          5'b10010: data <= 5'b00111; 
          5'b10011: data <= 5'b00011; 
          5'b10100: data <= 5'b11111; 
          5'b10101: data <= 5'b11011; 
          5'b10110: data <= 5'b10111; 
          5'b10111: data <= 5'b10011; 
          5'b11000: data <= 5'b01101; 
          5'b11001: data <= 5'b01001; 
          5'b11010: data <= 5'b00101; 
          5'b11011: data <= 5'b00001; 
          5'b11100: data <= 5'b11101; 
          5'b11101: data <= 5'b11001; 
          5'b11110: data <= 5'b10101; 
          5'b11111: data <= 5'b10001; 
          default: data <= 5'b0; 
        endcase
    end
  end                              
    ...
    if(rst) begin                    
      ...
      if (en)                           
        case(addr)                        
          ...
          5'b01000: data <= 5'b11110; 
          5'b01001: data <= 5'b11010; 
          5'b01010: data <= 5'b10110; 
          5'b01011: data <= 5'b10010; 
          5'b01100: data <= 5'b01110; 
          5'b01101: data <= 5'b01010; 
          5'b01110: data <= 5'b00110; 
          5'b01111: data <= 5'b00010; 
          5'b10000: data <= 5'b11101; 
          5'b10001: data <= 5'b11001; 
          5'b10010: data <= 5'b10101; 
          5'b10011: data <= 5'b10001; 
          5'b10100: data <= 5'b01101; 
          5'b10101: data <= 5'b01001; 
          5'b10110: data <= 5'b00101; 
          5'b10111: data <= 5'b00001; 
...
data                             
  ...
  begin                            
    if(rst) begin                    
      ...
      if (en)                           
        case(addr)                        
          5'b00000: data <= 5'b11110; 
          5'b00001: data <= 5'b11010; 
          5'b00010: data <= 5'b10110; 
          5'b00011: data <= 5'b10010; 
          5'b00100: data <= 5'b01110; 
          5'b00101: data <= 5'b01010; 
          5'b00110: data <= 5'b00110; 
          5'b00111: data <= 5'b00010; 
          5'b01000: data <= 5'b11100; 
          5'b01001: data <= 5'b11000; 
          5'b01010: data <= 5'b10100; 
          5'b01011: data <= 5'b10000; 
          5'b01100: data <= 5'b01100; 
          5'b01101: data <= 5'b01000; 
          5'b01110: data <= 5'b00100; 
          5'b01111: data <= 5'b00000; 
          5'b10000: data <= 5'b11111; 
          5'b10001: data <= 5'b11011; 
          5'b10010: data <= 5'b10111; 
          5'b10011: data <= 5'b10011; 
          5'b10100: data <= 5'b01111; 
          5'b10101: data <= 5'b01011; 
          5'b10110: data <= 5'b00111; 
          5'b10111: data <= 5'b00011; 
          5'b11000: data <= 5'b11101; 
          5'b11001: data <= 5'b11001; 
          5'b11010: data <= 5'b10101; 
          5'b11011: data <= 5'b10001; 
          5'b11100: data <= 5'b01101; 
          5'b11101: data <= 5'b01001; 
          5'b11110: data <= 5'b00101; 
          5'b11111: data <= 5'b00001; 
          default: data <= 5'b0; 
        endcase
    end
  end                              
...
module  s5_addr_rom_ctrl_dp32_per0(
in_start,                          
wen_out,                         
out_start,                         
rom_out_0,                         
...
rst                              
  ...
  s5_addr_rom_dp32_mem0 addr_rom_inst_0(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_0)); 
  s5_addr_rom_dp32_mem1 addr_rom_inst_1(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_1)); 
  s5_addr_rom_dp32_mem2 addr_rom_inst_2(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_2)); 
  s5_addr_rom_dp32_mem3 addr_rom_inst_3(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_3)); 
  s5_addr_rom_dp32_mem4 addr_rom_inst_4(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_4)); 
  s5_addr_rom_dp32_mem5 addr_rom_inst_5(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_5)); 
  s5_addr_rom_dp32_mem6 addr_rom_inst_6(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_6)); 
  s5_addr_rom_dp32_mem7 addr_rom_inst_7(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_7)); 
  s5_addr_rom_dp32_mem8 addr_rom_inst_8(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_8)); 
  s5_addr_rom_dp32_mem9 addr_rom_inst_9(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_9)); 
  s5_addr_rom_dp32_mem10 addr_rom_inst_10(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_10)); 
  s5_addr_rom_dp32_mem11 addr_rom_inst_11(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_11)); 
  s5_addr_rom_dp32_mem12 addr_rom_inst_12(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_12)); 
  s5_addr_rom_dp32_mem13 addr_rom_inst_13(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_13)); 
  s5_addr_rom_dp32_mem14 addr_rom_inst_14(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_14)); 
  s5_addr_rom_dp32_mem15 addr_rom_inst_15(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_15)); 
  s5_addr_rom_dp32_mem16 addr_rom_inst_16(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_16)); 
  s5_addr_rom_dp32_mem17 addr_rom_inst_17(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_17)); 
  s5_addr_rom_dp32_mem18 addr_rom_inst_18(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_18)); 
  s5_addr_rom_dp32_mem19 addr_rom_inst_19(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_19)); 
  s5_addr_rom_dp32_mem20 addr_rom_inst_20(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_20)); 
  s5_addr_rom_dp32_mem21 addr_rom_inst_21(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_21)); 
  s5_addr_rom_dp32_mem22 addr_rom_inst_22(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_22)); 
  s5_addr_rom_dp32_mem23 addr_rom_inst_23(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_23)); 
  s5_addr_rom_dp32_mem24 addr_rom_inst_24(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_24)); 
  s5_addr_rom_dp32_mem25 addr_rom_inst_25(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_25)); 
  s5_addr_rom_dp32_mem26 addr_rom_inst_26(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_26)); 
  s5_addr_rom_dp32_mem27 addr_rom_inst_27(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_27)); 
  s5_addr_rom_dp32_mem28 addr_rom_inst_28(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_28)); 
  s5_addr_rom_dp32_mem29 addr_rom_inst_29(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_29)); 
  s5_addr_rom_dp32_mem30 addr_rom_inst_30(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_30)); 
  s5_addr_rom_dp32_mem31 addr_rom_inst_31(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_31)); 
...
rst                              
  ...
  always @ (posedge clk) begin
    if (rst | in_start) begin
      read_address <= 5'b11111 - 3'b100 - 3'b010 - 1'b1;
    end else begin
  ...
  s5_addr_rom_ctrl_dp32_per0 addr_gen_inst(.in_start(in_start), .wen_out(wen_wire), .out_start(out_start_wire), .rom_out_0(addr_w_wire_0), .rom_out_1(addr_w_wire_1), .rom_out_2(addr_w_wire_2), .rom_out_3(addr_w_wire_3), .rom_out_4(addr_w_wire_4), .rom_out_5(addr_w_wire_5), .rom_out_6(addr_w_wire_6), .rom_out_7(addr_w_wire_7), .rom_out_8(addr_w_wire_8), .rom_out_9(addr_w_wire_9), .rom_out_10(addr_w_wire_10), .rom_out_11(addr_w_wire_11), .rom_out_12(addr_w_wire_12), .rom_out_13(addr_w_wire_13), .rom_out_14(addr_w_wire_14), .rom_out_15(addr_w_wire_15), .rom_out_16(addr_w_wire_16), .rom_out_17(addr_w_wire_17), .rom_out_18(addr_w_wire_18), .rom_out_19(addr_w_wire_19), .rom_out_20(addr_w_wire_20), .rom_out_21(addr_w_wire_21), .rom_out_22(addr_w_wire_22), .rom_out_23(addr_w_wire_23), .rom_out_24(addr_w_wire_24), .rom_out_25(addr_w_wire_25), .rom_out_26(addr_w_wire_26), .rom_out_27(addr_w_wire_27), .rom_out_28(addr_w_wire_28), .rom_out_29(addr_w_wire_29), .rom_out_30(addr_w_wire_30), .rom_out_31(addr_w_wire_31), .clk(clk), .rst(rst));
