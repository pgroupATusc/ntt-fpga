...
module ctrl_rom_dp64_st0_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp64_st0_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp64_st0_per0L ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module ctrl_rom_dp64_st1_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp64_st1_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp64_st1_per0L ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module ctrl_rom_dp64_st2_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp64_st2_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp64_st2_per0L ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module ctrl_rom_dp64_st3_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp64_st3_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp64_st3_per0L ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module ctrl_rom_dp64_st4_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp64_st4_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp64_st4_per0L ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module ctrl_rom_dp64_st5_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp64_st5_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp64_st5_per0L ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
rst                              
  ...
  switch_ctrl_dp64_st0_per0L switch_ctrl_stage_0(.in_start(in_start_stage0),.ctrl_out(wire_ctrl_stage0),.clk(clk), .rst(rst));
  ...
  switch_ctrl_dp64_st1_per0L switch_ctrl_stage_1(.in_start(in_start_stage1),.ctrl_out(wire_ctrl_stage1),.clk(clk), .rst(rst));
  ...
  switch_ctrl_dp64_st2_per0L switch_ctrl_stage_2(.in_start(in_start_stage2),.ctrl_out(wire_ctrl_stage2),.clk(clk), .rst(rst));
  ...
  switch_ctrl_dp64_st3_per0L switch_ctrl_stage_3(.in_start(in_start_stage3),.ctrl_out(wire_ctrl_stage3),.clk(clk), .rst(rst));
  ...
  switch_ctrl_dp64_st4_per0L switch_ctrl_stage_4(.in_start(in_start_stage4),.ctrl_out(wire_ctrl_stage4),.clk(clk), .rst(rst));
  ...
  switch_ctrl_dp64_st5_per0L switch_ctrl_stage_5(.in_start(in_start_stage5),.ctrl_out(wire_ctrl_stage5),.clk(clk), .rst(rst));
...
module ctrl_rom_dp64_st0_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp64_st0_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp64_st0_per0R ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module ctrl_rom_dp64_st1_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp64_st1_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp64_st1_per0R ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module ctrl_rom_dp64_st2_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp64_st2_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp64_st2_per0R ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module ctrl_rom_dp64_st3_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp64_st3_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp64_st3_per0R ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module ctrl_rom_dp64_st4_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp64_st4_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp64_st4_per0R ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module ctrl_rom_dp64_st5_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp64_st5_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp64_st5_per0R ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
rst                              
  ...
  switch_ctrl_dp64_st5_per0R switch_ctrl_stage_5(.in_start(con_in_start_stage5),.ctrl_out(wire_ctrl_stage5),.clk(clk), .rst(rst));
  ...
  switch_ctrl_dp64_st4_per0R switch_ctrl_stage_4(.in_start(con_in_start_stage4),.ctrl_out(wire_ctrl_stage4),.clk(clk), .rst(rst));
  ...
  switch_ctrl_dp64_st3_per0R switch_ctrl_stage_3(.in_start(con_in_start_stage3),.ctrl_out(wire_ctrl_stage3),.clk(clk), .rst(rst));
  ...
  switch_ctrl_dp64_st2_per0R switch_ctrl_stage_2(.in_start(con_in_start_stage2),.ctrl_out(wire_ctrl_stage2),.clk(clk), .rst(rst));
  ...
  switch_ctrl_dp64_st1_per0R switch_ctrl_stage_1(.in_start(con_in_start_stage1),.ctrl_out(wire_ctrl_stage1),.clk(clk), .rst(rst));
  ...
  switch_ctrl_dp64_st0_per0R switch_ctrl_stage_0(.in_start(con_in_start_stage0),.ctrl_out(wire_ctrl_stage0),.clk(clk), .rst(rst));
...
module  addr_rom_ctrl_dp64_per0(
in_start,                          
wen_out,                         
out_start,                         
rom_out_0,                         
...
rst                              
  ...
  addr_rom_dp64_mem0 addr_rom_inst_0(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_0)); 
  addr_rom_dp64_mem1 addr_rom_inst_1(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_1)); 
  addr_rom_dp64_mem2 addr_rom_inst_2(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_2)); 
  addr_rom_dp64_mem3 addr_rom_inst_3(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_3)); 
  addr_rom_dp64_mem4 addr_rom_inst_4(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_4)); 
  addr_rom_dp64_mem5 addr_rom_inst_5(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_5)); 
  addr_rom_dp64_mem6 addr_rom_inst_6(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_6)); 
  addr_rom_dp64_mem7 addr_rom_inst_7(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_7)); 
  addr_rom_dp64_mem8 addr_rom_inst_8(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_8)); 
  addr_rom_dp64_mem9 addr_rom_inst_9(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_9)); 
  addr_rom_dp64_mem10 addr_rom_inst_10(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_10)); 
  addr_rom_dp64_mem11 addr_rom_inst_11(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_11)); 
  addr_rom_dp64_mem12 addr_rom_inst_12(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_12)); 
  addr_rom_dp64_mem13 addr_rom_inst_13(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_13)); 
  addr_rom_dp64_mem14 addr_rom_inst_14(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_14)); 
  addr_rom_dp64_mem15 addr_rom_inst_15(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_15)); 
  addr_rom_dp64_mem16 addr_rom_inst_16(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_16)); 
  addr_rom_dp64_mem17 addr_rom_inst_17(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_17)); 
  addr_rom_dp64_mem18 addr_rom_inst_18(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_18)); 
  addr_rom_dp64_mem19 addr_rom_inst_19(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_19)); 
  addr_rom_dp64_mem20 addr_rom_inst_20(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_20)); 
  addr_rom_dp64_mem21 addr_rom_inst_21(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_21)); 
  addr_rom_dp64_mem22 addr_rom_inst_22(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_22)); 
  addr_rom_dp64_mem23 addr_rom_inst_23(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_23)); 
  addr_rom_dp64_mem24 addr_rom_inst_24(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_24)); 
  addr_rom_dp64_mem25 addr_rom_inst_25(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_25)); 
  addr_rom_dp64_mem26 addr_rom_inst_26(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_26)); 
  addr_rom_dp64_mem27 addr_rom_inst_27(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_27)); 
  addr_rom_dp64_mem28 addr_rom_inst_28(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_28)); 
  addr_rom_dp64_mem29 addr_rom_inst_29(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_29)); 
  addr_rom_dp64_mem30 addr_rom_inst_30(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_30)); 
  addr_rom_dp64_mem31 addr_rom_inst_31(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_31)); 
  addr_rom_dp64_mem32 addr_rom_inst_32(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_32)); 
  addr_rom_dp64_mem33 addr_rom_inst_33(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_33)); 
  addr_rom_dp64_mem34 addr_rom_inst_34(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_34)); 
  addr_rom_dp64_mem35 addr_rom_inst_35(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_35)); 
  addr_rom_dp64_mem36 addr_rom_inst_36(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_36)); 
  addr_rom_dp64_mem37 addr_rom_inst_37(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_37)); 
  addr_rom_dp64_mem38 addr_rom_inst_38(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_38)); 
  addr_rom_dp64_mem39 addr_rom_inst_39(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_39)); 
  addr_rom_dp64_mem40 addr_rom_inst_40(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_40)); 
  addr_rom_dp64_mem41 addr_rom_inst_41(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_41)); 
  addr_rom_dp64_mem42 addr_rom_inst_42(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_42)); 
  addr_rom_dp64_mem43 addr_rom_inst_43(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_43)); 
  addr_rom_dp64_mem44 addr_rom_inst_44(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_44)); 
  addr_rom_dp64_mem45 addr_rom_inst_45(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_45)); 
  addr_rom_dp64_mem46 addr_rom_inst_46(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_46)); 
  addr_rom_dp64_mem47 addr_rom_inst_47(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_47)); 
  addr_rom_dp64_mem48 addr_rom_inst_48(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_48)); 
  addr_rom_dp64_mem49 addr_rom_inst_49(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_49)); 
  addr_rom_dp64_mem50 addr_rom_inst_50(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_50)); 
  addr_rom_dp64_mem51 addr_rom_inst_51(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_51)); 
  addr_rom_dp64_mem52 addr_rom_inst_52(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_52)); 
  addr_rom_dp64_mem53 addr_rom_inst_53(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_53)); 
  addr_rom_dp64_mem54 addr_rom_inst_54(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_54)); 
  addr_rom_dp64_mem55 addr_rom_inst_55(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_55)); 
  addr_rom_dp64_mem56 addr_rom_inst_56(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_56)); 
  addr_rom_dp64_mem57 addr_rom_inst_57(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_57)); 
  addr_rom_dp64_mem58 addr_rom_inst_58(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_58)); 
  addr_rom_dp64_mem59 addr_rom_inst_59(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_59)); 
  addr_rom_dp64_mem60 addr_rom_inst_60(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_60)); 
  addr_rom_dp64_mem61 addr_rom_inst_61(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_61)); 
  addr_rom_dp64_mem62 addr_rom_inst_62(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_1),.data(rom_out_62)); 
  addr_rom_dp64_mem63 addr_rom_inst_63(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_63)); 
