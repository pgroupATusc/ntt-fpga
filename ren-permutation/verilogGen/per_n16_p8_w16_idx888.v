...
rst                              
  ...
  assign wireOut[0]= wireIn[0]; 
  assign wireOut[2] = wireIn[3]; 
  assign wireOut[3]= wireIn[2]; 
  assign wireOut[5] = wireIn[5]; 
  assign wireOut[4]= wireIn[4]; 
  assign wireOut[6] = wireIn[7]; 
  assign wireOut[7]= wireIn[6]; 
...
rst                              
  ...
  assign wireOut[0] = wireIn[1]; 
  assign wireOut[1]= wireIn[0]; 
  assign wireOut[2] = wireIn[3]; 
  assign wireOut[3]= wireIn[2]; 
  assign wireOut[4] = wireIn[5]; 
  assign wireOut[5]= wireIn[4]; 
  assign wireOut[6] = wireIn[7]; 
  assign wireOut[7]= wireIn[6]; 
...
rst                              
  ...
  assign wire_ctrl_stage1[2] = counter_w[0]; 
  assign wire_ctrl_stage1[3] = counter_w[0]; 
...
rst                              
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[2] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[3] <= counter_w[0]; 
  end                            
...
module  mem_addr_gen_dp8_mem0_per888(
counter_in,                              
clk,                             
rst,                             
addr_out                            
...
module  mem_addr_ctrl_dp8_per888(
in_start,                          
counter_in,                         
wen_out,                         
out_start,                         
...
rst                              
  ...
  mem_addr_gen_dp8_mem0_per888 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter_in)); 

  assign mem_addr_out_w_h = mem_addr_out_w[0:0];        
  assign mem_addr_out_tmp_0 = {mem_addr_out_w[0]}; 
  assign mem_addr_out_tmp_1 = {mem_addr_out_w[0]}; 
  assign mem_addr_out_tmp_2 = {mem_addr_out_w[0]}; 
  assign mem_addr_out_tmp_3 = {mem_addr_out_w[0]}; 
  assign mem_addr_out_tmp_4 = {~mem_addr_out_w[0]}; 
  assign mem_addr_out_tmp_5 = {~mem_addr_out_w[0]}; 
  assign mem_addr_out_tmp_6 = {~mem_addr_out_w[0]}; 
  assign mem_addr_out_tmp_7 = {~mem_addr_out_w[0]}; 
...
rst                              
  ...
  mem_addr_ctrl_dp8_per888 addr_gen_inst(.in_start(in_start), .counter_in(counter_in), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .mem_addr_out_2(addr_wire_2), .mem_addr_out_3(addr_wire_3), .mem_addr_out_4(addr_wire_4), .mem_addr_out_5(addr_wire_5), .mem_addr_out_6(addr_wire_6), .mem_addr_out_7(addr_wire_7), .clk(clk), .rst(rst));
