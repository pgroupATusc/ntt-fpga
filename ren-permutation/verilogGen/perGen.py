 ...
 *                                                                                       \n   \
 * Copyright (c) 2017-2023 by Ren Chen for his Ph.D Project,                             \n   \
...
def getCtrl(inputSize, dp, stride, perIdx, raSel):
    ...
    subprocess.call(["../ctrlGen/perGen", str(inputSize), str(dp), str(stride), str(raSel), str(perIdx), printDebugInfo], shell=True)
