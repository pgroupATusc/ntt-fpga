...
rst                              
  ...
  switches_stage_st1_8_L switch_stage_1(
...
rst                              
  ...
  switches_stage_st1_8_R switch_stage_1(
...
module  mem_addr_gen_dp4_mem0_per8(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  assign addr_out[7:6] = addr_a0[1:0];   
  
  assign word_counter_w[0] = counter_in[5:2];  
  assign addr_a0 = counter_in[7:6]; 
  assign addr_a1 = counter_in[1:0]; 
    
endmodule                        


module  mem_addr_ctrl_dp4_per8(
in_start,                          
counter_in,                         
wen_out,                         
out_start,                         
...
rst                              
  ...
  mem_addr_gen_dp4_mem0_per8 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter_in)); 
...
rst                              
  ...
  mem_addr_ctrl_dp4_per8 addr_gen_inst(.in_start(in_start), .counter_in(counter_in), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .mem_addr_out_2(addr_wire_2), .mem_addr_out_3(addr_wire_3), .clk(clk), .rst(rst));
