...
addr_out                            
  ...
  assign addr_out[10:8] = {addr_a1[0],addr_a1[1],addr_a1[2]};   
  assign addr_out[11:11] = addr_a0[0:0];   
  
  assign word_counter_w[0] = counter_in[6:3];  
  assign word_counter_w[1] = counter_in[10:7];  
  assign addr_a0 = counter_in[11:11]; 
...
rst                              
  ...
  wire [10:0] mem_addr_out_w_l;        
  
  mem_addr_gen_dp2_mem0_per5 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter_in)); 

  assign mem_addr_out_w_h = mem_addr_out_w[11:11];        
  assign mem_addr_out_w_l = mem_addr_out_w[10:0];   
...
rst                              
  ...
  mem_addr_ctrl_dp2_per5 addr_gen_inst(.in_start(in_start), .counter_in(counter_in), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .clk(clk), .rst(rst));
