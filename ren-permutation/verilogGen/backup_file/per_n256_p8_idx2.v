...
rst                              
  ...
  wire [4:0] counter_out_w;
  counter_32 switch_ctrl(.in_start(in_start_stage2), .counter_out(counter_out_w), .clk(clk), .rst(rst));
...
module  mem_addr_gen_dp8_mem0_per2(
counter_in,                              
clk,                             
rst,                             
addr_out                            
...
rst                              
  ...
  mem_addr_gen_dp8_mem0_per2 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter)); 
...
rst                              
  ...
  mem_addr_ctrl_dp8_per2 addr_gen_inst(.in_start(in_start), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .mem_addr_out_2(addr_wire_2), .mem_addr_out_3(addr_wire_3), .mem_addr_out_4(addr_wire_4), .mem_addr_out_5(addr_wire_5), .mem_addr_out_6(addr_wire_6), .mem_addr_out_7(addr_wire_7), .clk(clk), .rst(rst));
