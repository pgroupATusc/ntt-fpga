...
module switches_stage_st0_22_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_22_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st2_22_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st3_22_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st0_22_L switch_stage_0(
  ...
  switches_stage_st1_22_L switch_stage_1(
  ...
  switches_stage_st2_22_L switch_stage_2(
  ...
  switches_stage_st3_22_L switch_stage_3(
...
module switches_stage_st0_22_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_22_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st2_22_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st3_22_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st3_22_R switch_stage_3(
  ...
  switches_stage_st2_22_R switch_stage_2(
  ...
  switches_stage_st1_22_R switch_stage_1(
  ...
  switches_stage_st0_22_R switch_stage_0(
...
module  mem_addr_gen_dp16_mem0_per22(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  assign addr_out[7:4] = addr_a0[3:0];   
  
  assign word_counter_w[0] = counter_in[3:0];  
  assign addr_a0 = counter_in[7:4]; 
  
endmodule                        


module  mem_addr_ctrl_dp16_per22(
in_start,                          
counter_in,                         
wen_out,                         
out_start,                         
...
rst                              
  ...
  mem_addr_gen_dp16_mem0_per22 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter_in)); 

  assign mem_addr_out_w_h = mem_addr_out_w[7:4];        
...
rst                              
  ...
  wire [7:0] addr_wire_0;        

  wire [7:0] addr_wire_1;        

  wire [7:0] addr_wire_2;        

  wire [7:0] addr_wire_3;        

  wire [7:0] addr_wire_4;        

  wire [7:0] addr_wire_5;        

  wire [7:0] addr_wire_6;        

  wire [7:0] addr_wire_7;        

  wire [7:0] addr_wire_8;        

  wire [7:0] addr_wire_9;        

  wire [7:0] addr_wire_10;        

  wire [7:0] addr_wire_11;        

  wire [7:0] addr_wire_12;        

  wire [7:0] addr_wire_13;        

  wire [7:0] addr_wire_14;        

  wire [7:0] addr_wire_15;        

  mem_addr_ctrl_dp16_per22 addr_gen_inst(.in_start(in_start), .counter_in(counter_in), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .mem_addr_out_2(addr_wire_2), .mem_addr_out_3(addr_wire_3), .mem_addr_out_4(addr_wire_4), .mem_addr_out_5(addr_wire_5), .mem_addr_out_6(addr_wire_6), .mem_addr_out_7(addr_wire_7), .mem_addr_out_8(addr_wire_8), .mem_addr_out_9(addr_wire_9), .mem_addr_out_10(addr_wire_10), .mem_addr_out_11(addr_wire_11), .mem_addr_out_12(addr_wire_12), .mem_addr_out_13(addr_wire_13), .mem_addr_out_14(addr_wire_14), .mem_addr_out_15(addr_wire_15), .clk(clk), .rst(rst));

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(8)) 
