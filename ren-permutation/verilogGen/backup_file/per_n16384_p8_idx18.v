...
module switches_stage_st0_18_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_18_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st2_18_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st0_18_L switch_stage_0(
  ...
  assign wire_ctrl_stage0[2] = counter_w[10]; 
  assign wire_ctrl_stage0[3] = counter_w[10]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage1[7:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage1[7:0];
  wire [3:0] wire_ctrl_stage1;

  switches_stage_st1_18_L switch_stage_1(
  ...
  assign wire_ctrl_stage1[2] = counter_w[9]; 
  assign wire_ctrl_stage1[3] = counter_w[9]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage2[7:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage2[7:0];
  wire [3:0] wire_ctrl_stage2;

  switches_stage_st2_18_L switch_stage_2(
  ...
  assign wire_ctrl_stage2[0] = counter_w[8]; 
  assign wire_ctrl_stage2[1] = counter_w[8]; 
  assign wire_ctrl_stage2[2] = counter_w[8]; 
  assign wire_ctrl_stage2[3] = counter_w[8]; 
...
module switches_stage_st0_18_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_18_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st2_18_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st2_18_R switch_stage_2(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[0] <= counter_w[8]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[1] <= counter_w[8]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[2] <= counter_w[8]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[3] <= counter_w[8]; 
  end                            
  ...
  switches_stage_st1_18_R switch_stage_1(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[2] <= counter_w[9]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[3] <= counter_w[9]; 
  end                            
  ...
  switches_stage_st0_18_R switch_stage_0(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[2] <= counter_w[10]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[3] <= counter_w[10]; 
  end                            
...
module  mem_addr_gen_dp8_mem0_per18(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  assign addr_out[10:8] = addr_a0[2:0];   
  
  assign word_counter_w[0] = counter_in[3:0];  
  assign word_counter_w[1] = counter_in[7:4];  
  assign addr_a0 = counter_in[10:8]; 
  
endmodule                        


module  mem_addr_ctrl_dp8_per18(
in_start,                          
counter_in,                         
wen_out,                         
out_start,                         
...
rst                              
  ...
  mem_addr_gen_dp8_mem0_per18 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter_in)); 
...
rst                              
  ...
  wire [10:0] addr_wire_4;        

  wire [10:0] addr_wire_5;        

  wire [10:0] addr_wire_6;        

  wire [10:0] addr_wire_7;        

  mem_addr_ctrl_dp8_per18 addr_gen_inst(.in_start(in_start), .counter_in(counter_in), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .mem_addr_out_2(addr_wire_2), .mem_addr_out_3(addr_wire_3), .mem_addr_out_4(addr_wire_4), .mem_addr_out_5(addr_wire_5), .mem_addr_out_6(addr_wire_6), .mem_addr_out_7(addr_wire_7), .clk(clk), .rst(rst));
