...
module switches_stage_st0_19_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_19_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st2_19_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st3_19_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st0_19_L switch_stage_0(
  ...
  assign wire_ctrl_stage0[4] = counter_w[3]; 
  assign wire_ctrl_stage0[5] = counter_w[3]; 
  assign wire_ctrl_stage0[6] = counter_w[3]; 
  assign wire_ctrl_stage0[7] = counter_w[3]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage1[15:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage1[15:0];
  wire [7:0] wire_ctrl_stage1;

  switches_stage_st1_19_L switch_stage_1(
  ...
  assign wire_ctrl_stage1[4] = counter_w[2]; 
  assign wire_ctrl_stage1[5] = counter_w[2]; 
  assign wire_ctrl_stage1[6] = counter_w[2]; 
  assign wire_ctrl_stage1[7] = counter_w[2]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage2[15:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage2[15:0];
  wire [7:0] wire_ctrl_stage2;

  switches_stage_st2_19_L switch_stage_2(
  ...
  assign wire_ctrl_stage2[4] = counter_w[1]; 
  assign wire_ctrl_stage2[5] = counter_w[1]; 
  assign wire_ctrl_stage2[6] = counter_w[1]; 
  assign wire_ctrl_stage2[7] = counter_w[1]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage3[15:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage3[15:0];
  wire [7:0] wire_ctrl_stage3;

  switches_stage_st3_19_L switch_stage_3(
  ...
  assign wire_ctrl_stage3[0] = counter_w[0]; 
  assign wire_ctrl_stage3[1] = counter_w[0]; 
  assign wire_ctrl_stage3[2] = counter_w[0]; 
  assign wire_ctrl_stage3[3] = counter_w[0]; 
  assign wire_ctrl_stage3[4] = counter_w[0]; 
  assign wire_ctrl_stage3[5] = counter_w[0]; 
  assign wire_ctrl_stage3[6] = counter_w[0]; 
  assign wire_ctrl_stage3[7] = counter_w[0]; 
...
module switches_stage_st0_19_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_19_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st2_19_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st3_19_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st3_19_R switch_stage_3(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[0] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[1] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[2] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[3] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[4] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[5] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[6] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[7] <= counter_w[0]; 
  end                            
  ...
  switches_stage_st2_19_R switch_stage_2(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[4] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[5] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[6] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[7] <= counter_w[1]; 
  end                            
  ...
  switches_stage_st1_19_R switch_stage_1(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[4] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[5] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[6] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[7] <= counter_w[2]; 
  end                            
  ...
  switches_stage_st0_19_R switch_stage_0(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[4] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[5] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[6] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[7] <= counter_w[3]; 
  end                            
...
module  mem_addr_gen_dp16_mem0_per19(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  wire [3:0] addr_a0;      
  assign addr_out[3:0] = addr_a0[3:0];   
  
  assign addr_a0 = counter_in[3:0]; 
  
endmodule                        


module  mem_addr_ctrl_dp16_per19(
in_start,                          
counter_in,                         
wen_out,                         
out_start,                         
...
rst                              
  ...
  mem_addr_gen_dp16_mem0_per19 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter_in)); 

  assign mem_addr_out_w_h = mem_addr_out_w[3:0];        
