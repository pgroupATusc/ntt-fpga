...
module switches_stage_st0_12_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_12_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st0_12_L switch_stage_0(
  ...
  assign wire_ctrl_stage0[0] = counter_w[11]; 
  assign wire_ctrl_stage0[1] = counter_w[11]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage1[3:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage1[3:0];
  wire [1:0] wire_ctrl_stage1;

  switches_stage_st1_12_L switch_stage_1(
  ...
  assign wire_ctrl_stage1[0] = counter_w[10]; 
  assign wire_ctrl_stage1[1] = counter_w[10]; 
...
module switches_stage_st0_12_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_12_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st1_12_R switch_stage_1(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[0] <= counter_w[10]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[1] <= counter_w[10]; 
  end                            
  ...
  switches_stage_st0_12_R switch_stage_0(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[0] <= counter_w[11]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[1] <= counter_w[11]; 
  end                            
...
module  mem_addr_gen_dp4_mem0_per12(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  assign addr_out[9:8] = {addr_a1[0],addr_a1[1]};   
  assign addr_out[11:10] = addr_a0[1:0];   
  
  assign word_counter_w[0] = counter_in[5:2];  
  assign word_counter_w[1] = counter_in[9:6];  
  assign addr_a0 = counter_in[11:10]; 
  assign addr_a1 = counter_in[1:0]; 
    
endmodule                        


module  mem_addr_ctrl_dp4_per12(
in_start,                          
counter_in,                         
wen_out,                         
out_start,                         
...
rst                              
  ...
  mem_addr_gen_dp4_mem0_per12 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter_in)); 
  ...
  begin                            
    if(rst) begin                    
      ...
      out_start <= (state == 2'b01) && (counter_in[11:0] == {12{1'b1}}); 
end                              
end                              
  ...
  begin                            
    if(rst) begin                    
      ...
      case (state)              
        ...
        2'b01: begin              
          if (!in_start && counter_in == {12{1'b1}})  begin 
            state <= 2'b11;              
          end
          if (counter_in == {12{1'b1}})  begin 
            flag <= !flag;              
          end
        end
        2'b11: begin              
...
rst                              
  ...
  wire [11:0] addr_wire_0;        

  wire [11:0] addr_wire_1;        

  wire [11:0] addr_wire_2;        

  wire [11:0] addr_wire_3;        

  mem_addr_ctrl_dp4_per12 addr_gen_inst(.in_start(in_start), .counter_in(counter_in), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .mem_addr_out_2(addr_wire_2), .mem_addr_out_3(addr_wire_3), .clk(clk), .rst(rst));

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(12)) 
...
rst                              
  ...
  counter_8192 ctrl_unit(.in_start(in_start), .counter_out(counter_out_w), .clk(clk), .rst(rst));
