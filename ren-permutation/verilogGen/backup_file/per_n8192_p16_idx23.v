...
module switches_stage_st0_23_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_23_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st2_23_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st3_23_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st0_23_L switch_stage_0(
  ...
  assign wire_ctrl_stage0[0] = counter_w[8]; 
  assign wire_ctrl_stage0[1] = counter_w[8]; 
  assign wire_ctrl_stage0[2] = counter_w[8]; 
  assign wire_ctrl_stage0[3] = counter_w[8]; 
  assign wire_ctrl_stage0[4] = counter_w[8]; 
  assign wire_ctrl_stage0[5] = counter_w[8]; 
  assign wire_ctrl_stage0[6] = counter_w[8]; 
  assign wire_ctrl_stage0[7] = counter_w[8]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage1[15:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage1[15:0];
  wire [7:0] wire_ctrl_stage1;

  switches_stage_st1_23_L switch_stage_1(
  ...
  assign wire_ctrl_stage1[0] = counter_w[7]; 
  assign wire_ctrl_stage1[1] = counter_w[7]; 
  assign wire_ctrl_stage1[2] = counter_w[7]; 
  assign wire_ctrl_stage1[3] = counter_w[7]; 
  assign wire_ctrl_stage1[4] = counter_w[7]; 
  assign wire_ctrl_stage1[5] = counter_w[7]; 
  assign wire_ctrl_stage1[6] = counter_w[7]; 
  assign wire_ctrl_stage1[7] = counter_w[7]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage2[15:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage2[15:0];
  wire [7:0] wire_ctrl_stage2;

  switches_stage_st2_23_L switch_stage_2(
  ...
  assign wire_ctrl_stage2[0] = counter_w[6]; 
  assign wire_ctrl_stage2[1] = counter_w[6]; 
  assign wire_ctrl_stage2[2] = counter_w[6]; 
  assign wire_ctrl_stage2[3] = counter_w[6]; 
  assign wire_ctrl_stage2[4] = counter_w[6]; 
  assign wire_ctrl_stage2[5] = counter_w[6]; 
  assign wire_ctrl_stage2[6] = counter_w[6]; 
  assign wire_ctrl_stage2[7] = counter_w[6]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage3[15:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage3[15:0];
  wire [7:0] wire_ctrl_stage3;

  switches_stage_st3_23_L switch_stage_3(
  ...
  assign wire_ctrl_stage3[0] = counter_w[5]; 
  assign wire_ctrl_stage3[1] = counter_w[5]; 
  assign wire_ctrl_stage3[2] = counter_w[5]; 
  assign wire_ctrl_stage3[3] = counter_w[5]; 
  assign wire_ctrl_stage3[4] = counter_w[5]; 
  assign wire_ctrl_stage3[5] = counter_w[5]; 
  assign wire_ctrl_stage3[6] = counter_w[5]; 
  assign wire_ctrl_stage3[7] = counter_w[5]; 
...
module switches_stage_st0_23_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_23_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st2_23_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st3_23_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st3_23_R switch_stage_3(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[0] <= counter_w[5]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[1] <= counter_w[5]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[2] <= counter_w[5]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[3] <= counter_w[5]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[4] <= counter_w[5]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[5] <= counter_w[5]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[6] <= counter_w[5]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[7] <= counter_w[5]; 
  end                            
  ...
  switches_stage_st2_23_R switch_stage_2(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[0] <= counter_w[6]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[1] <= counter_w[6]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[2] <= counter_w[6]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[3] <= counter_w[6]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[4] <= counter_w[6]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[5] <= counter_w[6]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[6] <= counter_w[6]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[7] <= counter_w[6]; 
  end                            
  ...
  switches_stage_st1_23_R switch_stage_1(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[0] <= counter_w[7]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[1] <= counter_w[7]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[2] <= counter_w[7]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[3] <= counter_w[7]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[4] <= counter_w[7]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[5] <= counter_w[7]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[6] <= counter_w[7]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[7] <= counter_w[7]; 
  end                            
  ...
  switches_stage_st0_23_R switch_stage_0(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[0] <= counter_w[8]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[1] <= counter_w[8]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[2] <= counter_w[8]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[3] <= counter_w[8]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[4] <= counter_w[8]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[5] <= counter_w[8]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[6] <= counter_w[8]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[7] <= counter_w[8]; 
  end                            
...
module  mem_addr_gen_dp16_mem0_per23(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  assign addr_out[8:5] = addr_a0[3:0];   
  
  assign word_counter_w[0] = counter_in[4:1];  
  assign addr_a0 = counter_in[8:5]; 
  assign addr_a1 = counter_in[0:0]; 
    
endmodule                        


module  mem_addr_ctrl_dp16_per23(
in_start,                          
counter_in,                         
wen_out,                         
out_start,                         
...
rst                              
  ...
  mem_addr_gen_dp16_mem0_per23 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter_in)); 

  assign mem_addr_out_w_h = mem_addr_out_w[8:5];        
  ...
  begin                            
    if(rst) begin                    
      ...
      out_start <= (state == 2'b01) && (counter_in[8:0] == {9{1'b1}}); 
end                              
end                              
  ...
  begin                            
    if(rst) begin                    
      ...
      case (state)              
        ...
        2'b01: begin              
          if (!in_start && counter_in == {9{1'b1}})  begin 
            state <= 2'b11;              
          end
          if (counter_in == {9{1'b1}})  begin 
            flag <= !flag;              
          end
        end
        2'b11: begin              
...
rst                              
  ...
  wire [8:0] addr_wire_4;        

  wire [8:0] addr_wire_5;        

  wire [8:0] addr_wire_6;        

  wire [8:0] addr_wire_7;        

  wire [8:0] addr_wire_8;        

  wire [8:0] addr_wire_9;        

  wire [8:0] addr_wire_10;        

  wire [8:0] addr_wire_11;        

  wire [8:0] addr_wire_12;        

  wire [8:0] addr_wire_13;        

  wire [8:0] addr_wire_14;        

  wire [8:0] addr_wire_15;        

  mem_addr_ctrl_dp16_per23 addr_gen_inst(.in_start(in_start), .counter_in(counter_in), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .mem_addr_out_2(addr_wire_2), .mem_addr_out_3(addr_wire_3), .mem_addr_out_4(addr_wire_4), .mem_addr_out_5(addr_wire_5), .mem_addr_out_6(addr_wire_6), .mem_addr_out_7(addr_wire_7), .mem_addr_out_8(addr_wire_8), .mem_addr_out_9(addr_wire_9), .mem_addr_out_10(addr_wire_10), .mem_addr_out_11(addr_wire_11), .mem_addr_out_12(addr_wire_12), .mem_addr_out_13(addr_wire_13), .mem_addr_out_14(addr_wire_14), .mem_addr_out_15(addr_wire_15), .clk(clk), .rst(rst));
...
rst                              
  ...
  counter_1024 ctrl_unit(.in_start(in_start), .counter_out(counter_out_w), .clk(clk), .rst(rst));
