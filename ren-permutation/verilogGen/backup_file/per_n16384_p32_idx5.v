...
rst                              
  ...
  wire [8:0] counter_out_w;
  counter_512 switch_ctrl(.in_start(in_start_stage0), .counter_out(counter_out_w), .clk(clk), .rst(rst));

  assign wire_ctrl_stage0[0] = counter_out_w[8]; 
  assign wire_ctrl_stage0[1] = counter_out_w[8]; 
  assign wire_ctrl_stage0[2] = counter_out_w[8]; 
  assign wire_ctrl_stage0[3] = counter_out_w[8]; 
  assign wire_ctrl_stage0[4] = counter_out_w[8]; 
  assign wire_ctrl_stage0[5] = counter_out_w[8]; 
  assign wire_ctrl_stage0[6] = counter_out_w[8]; 
  assign wire_ctrl_stage0[7] = counter_out_w[8]; 
  assign wire_ctrl_stage0[8] = counter_out_w[8]; 
  assign wire_ctrl_stage0[9] = counter_out_w[8]; 
  assign wire_ctrl_stage0[10] = counter_out_w[8]; 
  assign wire_ctrl_stage0[11] = counter_out_w[8]; 
  assign wire_ctrl_stage0[12] = counter_out_w[8]; 
  assign wire_ctrl_stage0[13] = counter_out_w[8]; 
  assign wire_ctrl_stage0[14] = counter_out_w[8]; 
  assign wire_ctrl_stage0[15] = counter_out_w[8]; 
  ...
  assign wire_ctrl_stage1[0] = counter_out_w[7]; 
  assign wire_ctrl_stage1[1] = counter_out_w[7]; 
  assign wire_ctrl_stage1[2] = counter_out_w[7]; 
  assign wire_ctrl_stage1[3] = counter_out_w[7]; 
  assign wire_ctrl_stage1[4] = counter_out_w[7]; 
  assign wire_ctrl_stage1[5] = counter_out_w[7]; 
  assign wire_ctrl_stage1[6] = counter_out_w[7]; 
  assign wire_ctrl_stage1[7] = counter_out_w[7]; 
  assign wire_ctrl_stage1[8] = counter_out_w[7]; 
  assign wire_ctrl_stage1[9] = counter_out_w[7]; 
  assign wire_ctrl_stage1[10] = counter_out_w[7]; 
  assign wire_ctrl_stage1[11] = counter_out_w[7]; 
  assign wire_ctrl_stage1[12] = counter_out_w[7]; 
  assign wire_ctrl_stage1[13] = counter_out_w[7]; 
  assign wire_ctrl_stage1[14] = counter_out_w[7]; 
  assign wire_ctrl_stage1[15] = counter_out_w[7]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage2[31:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage2[31:0];
  wire [15:0] wire_ctrl_stage2;

  switches_stage_st2_5_L switch_stage_2(
  ...
  assign wire_ctrl_stage2[0] = counter_out_w[6]; 
  assign wire_ctrl_stage2[1] = counter_out_w[6]; 
  assign wire_ctrl_stage2[2] = counter_out_w[6]; 
  assign wire_ctrl_stage2[3] = counter_out_w[6]; 
  assign wire_ctrl_stage2[4] = counter_out_w[6]; 
  assign wire_ctrl_stage2[5] = counter_out_w[6]; 
  assign wire_ctrl_stage2[6] = counter_out_w[6]; 
  assign wire_ctrl_stage2[7] = counter_out_w[6]; 
  assign wire_ctrl_stage2[8] = counter_out_w[6]; 
  assign wire_ctrl_stage2[9] = counter_out_w[6]; 
  assign wire_ctrl_stage2[10] = counter_out_w[6]; 
  assign wire_ctrl_stage2[11] = counter_out_w[6]; 
  assign wire_ctrl_stage2[12] = counter_out_w[6]; 
  assign wire_ctrl_stage2[13] = counter_out_w[6]; 
  assign wire_ctrl_stage2[14] = counter_out_w[6]; 
  assign wire_ctrl_stage2[15] = counter_out_w[6]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage3[31:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage3[31:0];
  wire [15:0] wire_ctrl_stage3;

  switches_stage_st3_5_L switch_stage_3(
  ...
  assign wire_ctrl_stage3[0] = counter_out_w[5]; 
  assign wire_ctrl_stage3[1] = counter_out_w[5]; 
  assign wire_ctrl_stage3[2] = counter_out_w[5]; 
  assign wire_ctrl_stage3[3] = counter_out_w[5]; 
  assign wire_ctrl_stage3[4] = counter_out_w[5]; 
  assign wire_ctrl_stage3[5] = counter_out_w[5]; 
  assign wire_ctrl_stage3[6] = counter_out_w[5]; 
  assign wire_ctrl_stage3[7] = counter_out_w[5]; 
  assign wire_ctrl_stage3[8] = counter_out_w[5]; 
  assign wire_ctrl_stage3[9] = counter_out_w[5]; 
  assign wire_ctrl_stage3[10] = counter_out_w[5]; 
  assign wire_ctrl_stage3[11] = counter_out_w[5]; 
  assign wire_ctrl_stage3[12] = counter_out_w[5]; 
  assign wire_ctrl_stage3[13] = counter_out_w[5]; 
  assign wire_ctrl_stage3[14] = counter_out_w[5]; 
  assign wire_ctrl_stage3[15] = counter_out_w[5]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage4[31:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage4[31:0];
  wire [15:0] wire_ctrl_stage4;

  switches_stage_st4_5_L switch_stage_4(
  ...
  assign wire_ctrl_stage4[0] = counter_out_w[4]; 
  assign wire_ctrl_stage4[1] = counter_out_w[4]; 
  assign wire_ctrl_stage4[2] = counter_out_w[4]; 
  assign wire_ctrl_stage4[3] = counter_out_w[4]; 
  assign wire_ctrl_stage4[4] = counter_out_w[4]; 
  assign wire_ctrl_stage4[5] = counter_out_w[4]; 
  assign wire_ctrl_stage4[6] = counter_out_w[4]; 
  assign wire_ctrl_stage4[7] = counter_out_w[4]; 
  assign wire_ctrl_stage4[8] = counter_out_w[4]; 
  assign wire_ctrl_stage4[9] = counter_out_w[4]; 
  assign wire_ctrl_stage4[10] = counter_out_w[4]; 
  assign wire_ctrl_stage4[11] = counter_out_w[4]; 
  assign wire_ctrl_stage4[12] = counter_out_w[4]; 
  assign wire_ctrl_stage4[13] = counter_out_w[4]; 
  assign wire_ctrl_stage4[14] = counter_out_w[4]; 
  assign wire_ctrl_stage4[15] = counter_out_w[4]; 
...
rst                              
  ...
  switches_stage_st4_5_R switch_stage_4(
  ...
  wire [8:0] counter_out_w;
  counter_512 switch_ctrl(.in_start(in_start_stage4), .counter_out(counter_out_w), .clk(clk), .rst(rst));
  ...
  switches_stage_st3_5_R switch_stage_3(
  ...
  switches_stage_st2_5_R switch_stage_2(
...
module  mem_addr_gen_dp32_mem0_per5(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  assign addr_out[8:7] = ms_word_high_w[1:0];    
  assign addr_out[9:8] = {ms_word_low_w[0],ms_word_low_w[1]};   
  
  assign word_counter_w[0] = counter_in[8:5];  
  assign word_counter_w[1] = counter_in[3:0];  
  assign ms_word_low_w = counter_in[3:2]; 
  assign ms_word_high_w = counter_in[4:3]; 
    
endmodule                        


module  mem_addr_ctrl_dp32_per5(
in_start,                          
wen_out,                         
out_start,                         
mem_addr_out_0,                         
...
rst                              
  ...
  input in_start, clk, rst;                   
  output [8:0] mem_addr_out_0;            
  output [8:0] mem_addr_out_1;            
  output [8:0] mem_addr_out_2;            
  output [8:0] mem_addr_out_3;            
  output [8:0] mem_addr_out_4;            
  output [8:0] mem_addr_out_5;            
  output [8:0] mem_addr_out_6;            
  output [8:0] mem_addr_out_7;            
  output [8:0] mem_addr_out_8;            
  output [8:0] mem_addr_out_9;            
  output [8:0] mem_addr_out_10;            
  output [8:0] mem_addr_out_11;            
  output [8:0] mem_addr_out_12;            
  output [8:0] mem_addr_out_13;            
  output [8:0] mem_addr_out_14;            
  output [8:0] mem_addr_out_15;            
  output [8:0] mem_addr_out_16;            
  output [8:0] mem_addr_out_17;            
  output [8:0] mem_addr_out_18;            
  output [8:0] mem_addr_out_19;            
  output [8:0] mem_addr_out_20;            
  output [8:0] mem_addr_out_21;            
  output [8:0] mem_addr_out_22;            
  output [8:0] mem_addr_out_23;            
  output [8:0] mem_addr_out_24;            
  output [8:0] mem_addr_out_25;            
  output [8:0] mem_addr_out_26;            
  output [8:0] mem_addr_out_27;            
  output [8:0] mem_addr_out_28;            
  output [8:0] mem_addr_out_29;            
  output [8:0] mem_addr_out_30;            
  output [8:0] mem_addr_out_31;            
  output wen_out;
  output out_start;
  ...
  wire [8:0] mem_addr_out_tmp_0;   
  wire [8:0] mem_addr_out_tmp_1;   
  wire [8:0] mem_addr_out_tmp_2;   
  wire [8:0] mem_addr_out_tmp_3;   
  wire [8:0] mem_addr_out_tmp_4;   
  wire [8:0] mem_addr_out_tmp_5;   
  wire [8:0] mem_addr_out_tmp_6;   
  wire [8:0] mem_addr_out_tmp_7;   
  wire [8:0] mem_addr_out_tmp_8;   
  wire [8:0] mem_addr_out_tmp_9;   
  wire [8:0] mem_addr_out_tmp_10;   
  wire [8:0] mem_addr_out_tmp_11;   
  wire [8:0] mem_addr_out_tmp_12;   
  wire [8:0] mem_addr_out_tmp_13;   
  wire [8:0] mem_addr_out_tmp_14;   
  wire [8:0] mem_addr_out_tmp_15;   
  wire [8:0] mem_addr_out_tmp_16;   
  wire [8:0] mem_addr_out_tmp_17;   
  wire [8:0] mem_addr_out_tmp_18;   
  wire [8:0] mem_addr_out_tmp_19;   
  wire [8:0] mem_addr_out_tmp_20;   
  wire [8:0] mem_addr_out_tmp_21;   
  wire [8:0] mem_addr_out_tmp_22;   
  wire [8:0] mem_addr_out_tmp_23;   
  wire [8:0] mem_addr_out_tmp_24;   
  wire [8:0] mem_addr_out_tmp_25;   
  wire [8:0] mem_addr_out_tmp_26;   
  wire [8:0] mem_addr_out_tmp_27;   
  wire [8:0] mem_addr_out_tmp_28;   
  wire [8:0] mem_addr_out_tmp_29;   
  wire [8:0] mem_addr_out_tmp_30;   
  wire [8:0] mem_addr_out_tmp_31;   
  wire [8:0] mem_addr_out_w;        
  wire [4:0] mem_addr_out_w_h;        
  wire [3:0] mem_addr_out_w_l;        
  
  mem_addr_gen_dp32_mem0_per5 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter)); 

  assign mem_addr_out_w_h = mem_addr_out_w[8:4];        
  ...
  assign out_start = (state == 2'b01) && (counter[8:0] == {9{1'b1}}); 
    ...
    if(rst) begin                    
      ...
      case (state)              
        ...
        2'b01: begin              
          ...
          if (!in_start && counter == {9{1'b1}})  begin 
            state <= 2'b11;              
          end
...
rst                              
  ...
  wire [8:0] addr_w_wire_0;        

  wire [8:0] addr_w_wire_1;        

  wire [8:0] addr_w_wire_2;        

  wire [8:0] addr_w_wire_3;        

  wire [8:0] addr_w_wire_4;        

  wire [8:0] addr_w_wire_5;        

  wire [8:0] addr_w_wire_6;        

  wire [8:0] addr_w_wire_7;        

  wire [8:0] addr_w_wire_8;        

  wire [8:0] addr_w_wire_9;        

  wire [8:0] addr_w_wire_10;        

  wire [8:0] addr_w_wire_11;        

  wire [8:0] addr_w_wire_12;        

  wire [8:0] addr_w_wire_13;        

  wire [8:0] addr_w_wire_14;        

  wire [8:0] addr_w_wire_15;        

  wire [8:0] addr_w_wire_16;        

  wire [8:0] addr_w_wire_17;        

  wire [8:0] addr_w_wire_18;        

  wire [8:0] addr_w_wire_19;        

  wire [8:0] addr_w_wire_20;        

  wire [8:0] addr_w_wire_21;        

  wire [8:0] addr_w_wire_22;        

  wire [8:0] addr_w_wire_23;        

  wire [8:0] addr_w_wire_24;        

  wire [8:0] addr_w_wire_25;        

  wire [8:0] addr_w_wire_26;        

  wire [8:0] addr_w_wire_27;        

  wire [8:0] addr_w_wire_28;        

  wire [8:0] addr_w_wire_29;        

  wire [8:0] addr_w_wire_30;        

  wire [8:0] addr_w_wire_31;        

  wire [8:0] addr_r_wire_0;        

  counter_512 counter_inst(.in_start(in_start), .counter_out(addr_r_wire_0), .clk(clk), .rst(rst));

  mem_addr_ctrl_dp32_per5 addr_gen_inst(.in_start(in_start), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .mem_addr_out_2(addr_wire_2), .mem_addr_out_3(addr_wire_3), .mem_addr_out_4(addr_wire_4), .mem_addr_out_5(addr_wire_5), .mem_addr_out_6(addr_wire_6), .mem_addr_out_7(addr_wire_7), .mem_addr_out_8(addr_wire_8), .mem_addr_out_9(addr_wire_9), .mem_addr_out_10(addr_wire_10), .mem_addr_out_11(addr_wire_11), .mem_addr_out_12(addr_wire_12), .mem_addr_out_13(addr_wire_13), .mem_addr_out_14(addr_wire_14), .mem_addr_out_15(addr_wire_15), .mem_addr_out_16(addr_wire_16), .mem_addr_out_17(addr_wire_17), .mem_addr_out_18(addr_wire_18), .mem_addr_out_19(addr_wire_19), .mem_addr_out_20(addr_wire_20), .mem_addr_out_21(addr_wire_21), .mem_addr_out_22(addr_wire_22), .mem_addr_out_23(addr_wire_23), .mem_addr_out_24(addr_wire_24), .mem_addr_out_25(addr_wire_25), .mem_addr_out_26(addr_wire_26), .mem_addr_out_27(addr_wire_27), .mem_addr_out_28(addr_wire_28), .mem_addr_out_29(addr_wire_29), .mem_addr_out_30(addr_wire_30), .mem_addr_out_31(addr_wire_31), .clk(clk), .rst(rst));

  block_ram_dp #(.DATA_WIDTH(32), .ADDR_WIDTH(9)) 
