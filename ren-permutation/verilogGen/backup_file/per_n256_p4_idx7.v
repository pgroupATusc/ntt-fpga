...
rst                              
  ...
  switches_stage_st0_7_L switch_stage_0(
  ...
  switches_stage_st1_7_L switch_stage_1(
...
rst                              
  ...
  switches_stage_st1_7_R switch_stage_1(
  ...
  switches_stage_st0_7_R switch_stage_0(
...
module  mem_addr_gen_dp4_mem0_per7(
counter_in,                              
clk,                             
rst,                             
addr_out                            
...
rst                              
  ...
  mem_addr_gen_dp4_mem0_per7 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter_in)); 
...
rst                              
  ...
  mem_addr_ctrl_dp4_per7 addr_gen_inst(.in_start(in_start), .counter_in(counter_in), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .mem_addr_out_2(addr_wire_2), .mem_addr_out_3(addr_wire_3), .clk(clk), .rst(rst));
