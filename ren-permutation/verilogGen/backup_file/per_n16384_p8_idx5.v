...
rst                              
  ...
  counter_2048 switch_ctrl(.in_start(in_start_stage0), .counter_out(counter_out_w), .clk(clk), .rst(rst));

  assign wire_ctrl_stage0[0] = counter_out_w[10]; 
  assign wire_ctrl_stage0[1] = counter_out_w[10]; 
  assign wire_ctrl_stage0[2] = counter_out_w[10]; 
  assign wire_ctrl_stage0[3] = counter_out_w[10]; 
  ...
  assign wire_ctrl_stage1[0] = counter_out_w[9]; 
  assign wire_ctrl_stage1[1] = counter_out_w[9]; 
  assign wire_ctrl_stage1[2] = counter_out_w[9]; 
  assign wire_ctrl_stage1[3] = counter_out_w[9]; 
  ...
  assign wire_ctrl_stage2[0] = counter_out_w[8]; 
  assign wire_ctrl_stage2[1] = counter_out_w[8]; 
  assign wire_ctrl_stage2[2] = counter_out_w[8]; 
  assign wire_ctrl_stage2[3] = counter_out_w[8]; 
...
rst                              
  ...
  wire [10:0] counter_out_w;
  counter_2048 switch_ctrl(.in_start(in_start_stage2), .counter_out(counter_out_w), .clk(clk), .rst(rst));
...
module  mem_addr_gen_dp8_mem0_per5(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  assign addr_out[10:9] = ms_word_high_w[1:0];    
  ...
  assign ms_word_low_w = counter_in[7:6]; 
  assign ms_word_high_w = counter_in[6:5]; 
    
endmodule                        


module  mem_addr_ctrl_dp8_per5(
in_start,                          
wen_out,                         
out_start,                         
mem_addr_out_0,                         
...
rst                              
  ...
  output [10:0] mem_addr_out_4;            
  output [10:0] mem_addr_out_5;            
  output [10:0] mem_addr_out_6;            
  output [10:0] mem_addr_out_7;            
  output wen_out;
  output out_start;
  ...
  wire [10:0] mem_addr_out_tmp_4;   
  wire [10:0] mem_addr_out_tmp_5;   
  wire [10:0] mem_addr_out_tmp_6;   
  wire [10:0] mem_addr_out_tmp_7;   
  wire [10:0] mem_addr_out_w;        
  wire [2:0] mem_addr_out_w_h;        
  wire [7:0] mem_addr_out_w_l;        
  
  mem_addr_gen_dp8_mem0_per5 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter)); 

  assign mem_addr_out_w_h = mem_addr_out_w[10:8];        
  assign mem_addr_out_w_l = mem_addr_out_w[7:0];   
  ...
  assign out_start = (state == 2'b01) && (counter[10:0] == {11{1'b1}}); 
    ...
    if(rst) begin                    
      ...
      case (state)              
        ...
        2'b01: begin              
          ...
          if (!in_start && counter == {11{1'b1}})  begin 
            state <= 2'b11;              
          end
...
rst                              
  ...
  wire [10:0] addr_w_wire_0;        

  wire [10:0] addr_w_wire_1;        

  wire [10:0] addr_w_wire_2;        

  wire [10:0] addr_w_wire_3;        

  wire [10:0] addr_w_wire_4;        

  wire [10:0] addr_w_wire_5;        

  wire [10:0] addr_w_wire_6;        

  wire [10:0] addr_w_wire_7;        

  wire [10:0] addr_r_wire_0;        

  counter_2048 counter_inst(.in_start(in_start), .counter_out(addr_r_wire_0), .clk(clk), .rst(rst));

  mem_addr_ctrl_dp8_per5 addr_gen_inst(.in_start(in_start), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .mem_addr_out_2(addr_wire_2), .mem_addr_out_3(addr_wire_3), .mem_addr_out_4(addr_wire_4), .mem_addr_out_5(addr_wire_5), .mem_addr_out_6(addr_wire_6), .mem_addr_out_7(addr_wire_7), .clk(clk), .rst(rst));

  block_ram_dp #(.DATA_WIDTH(32), .ADDR_WIDTH(11)) 
