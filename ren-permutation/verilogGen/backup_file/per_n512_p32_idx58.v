...
module switches_stage_st0_58_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_58_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st2_58_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st3_58_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st4_58_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st0_58_L switch_stage_0(
  ...
  counter_16 switch_ctrl(.in_start(in_start_stage0), .counter_out(counter_out_w), .clk(clk), .rst(rst));

  assign wire_ctrl_stage0[0] = counter_out_w[3]; 
  assign wire_ctrl_stage0[1] = counter_out_w[3]; 
  assign wire_ctrl_stage0[2] = counter_out_w[3]; 
  assign wire_ctrl_stage0[3] = counter_out_w[3]; 
  assign wire_ctrl_stage0[4] = counter_out_w[3]; 
  assign wire_ctrl_stage0[5] = counter_out_w[3]; 
  assign wire_ctrl_stage0[6] = counter_out_w[3]; 
  assign wire_ctrl_stage0[7] = counter_out_w[3]; 
  assign wire_ctrl_stage0[8] = counter_out_w[3]; 
  assign wire_ctrl_stage0[9] = counter_out_w[3]; 
  assign wire_ctrl_stage0[10] = counter_out_w[3]; 
  assign wire_ctrl_stage0[11] = counter_out_w[3]; 
  assign wire_ctrl_stage0[12] = counter_out_w[3]; 
  assign wire_ctrl_stage0[13] = counter_out_w[3]; 
  assign wire_ctrl_stage0[14] = counter_out_w[3]; 
  assign wire_ctrl_stage0[15] = counter_out_w[3]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage1[31:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage1[31:0];
  wire [15:0] wire_ctrl_stage1;

  switches_stage_st1_58_L switch_stage_1(
  ...
  assign wire_ctrl_stage1[0] = counter_out_w[2]; 
  assign wire_ctrl_stage1[1] = counter_out_w[2]; 
  assign wire_ctrl_stage1[2] = counter_out_w[2]; 
  assign wire_ctrl_stage1[3] = counter_out_w[2]; 
  assign wire_ctrl_stage1[4] = counter_out_w[2]; 
  assign wire_ctrl_stage1[5] = counter_out_w[2]; 
  assign wire_ctrl_stage1[6] = counter_out_w[2]; 
  assign wire_ctrl_stage1[7] = counter_out_w[2]; 
  assign wire_ctrl_stage1[8] = counter_out_w[2]; 
  assign wire_ctrl_stage1[9] = counter_out_w[2]; 
  assign wire_ctrl_stage1[10] = counter_out_w[2]; 
  assign wire_ctrl_stage1[11] = counter_out_w[2]; 
  assign wire_ctrl_stage1[12] = counter_out_w[2]; 
  assign wire_ctrl_stage1[13] = counter_out_w[2]; 
  assign wire_ctrl_stage1[14] = counter_out_w[2]; 
  assign wire_ctrl_stage1[15] = counter_out_w[2]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage2[31:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage2[31:0];
  wire [15:0] wire_ctrl_stage2;

  switches_stage_st2_58_L switch_stage_2(
  ...
  assign wire_ctrl_stage2[0] = counter_out_w[1]; 
  assign wire_ctrl_stage2[1] = counter_out_w[1]; 
  assign wire_ctrl_stage2[2] = counter_out_w[1]; 
  assign wire_ctrl_stage2[3] = counter_out_w[1]; 
  assign wire_ctrl_stage2[4] = counter_out_w[1]; 
  assign wire_ctrl_stage2[5] = counter_out_w[1]; 
  assign wire_ctrl_stage2[6] = counter_out_w[1]; 
  assign wire_ctrl_stage2[7] = counter_out_w[1]; 
  assign wire_ctrl_stage2[8] = counter_out_w[1]; 
  assign wire_ctrl_stage2[9] = counter_out_w[1]; 
  assign wire_ctrl_stage2[10] = counter_out_w[1]; 
  assign wire_ctrl_stage2[11] = counter_out_w[1]; 
  assign wire_ctrl_stage2[12] = counter_out_w[1]; 
  assign wire_ctrl_stage2[13] = counter_out_w[1]; 
  assign wire_ctrl_stage2[14] = counter_out_w[1]; 
  assign wire_ctrl_stage2[15] = counter_out_w[1]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage3[31:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage3[31:0];
  wire [15:0] wire_ctrl_stage3;

  switches_stage_st3_58_L switch_stage_3(
  ...
  assign wire_ctrl_stage3[0] = counter_out_w[0]; 
  assign wire_ctrl_stage3[1] = counter_out_w[0]; 
  assign wire_ctrl_stage3[2] = counter_out_w[0]; 
  assign wire_ctrl_stage3[3] = counter_out_w[0]; 
  assign wire_ctrl_stage3[4] = counter_out_w[0]; 
  assign wire_ctrl_stage3[5] = counter_out_w[0]; 
  assign wire_ctrl_stage3[6] = counter_out_w[0]; 
  assign wire_ctrl_stage3[7] = counter_out_w[0]; 
  assign wire_ctrl_stage3[8] = counter_out_w[0]; 
  assign wire_ctrl_stage3[9] = counter_out_w[0]; 
  assign wire_ctrl_stage3[10] = counter_out_w[0]; 
  assign wire_ctrl_stage3[11] = counter_out_w[0]; 
  assign wire_ctrl_stage3[12] = counter_out_w[0]; 
  assign wire_ctrl_stage3[13] = counter_out_w[0]; 
  assign wire_ctrl_stage3[14] = counter_out_w[0]; 
  assign wire_ctrl_stage3[15] = counter_out_w[0]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage4[31:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage4[31:0];
  wire [15:0] wire_ctrl_stage4;

  switches_stage_st4_58_L switch_stage_4(
  ...
  assign wire_ctrl_stage4[0] = counter_out_w[-1]; 
  assign wire_ctrl_stage4[1] = counter_out_w[-1]; 
  assign wire_ctrl_stage4[2] = counter_out_w[-1]; 
  assign wire_ctrl_stage4[3] = counter_out_w[-1]; 
  assign wire_ctrl_stage4[4] = counter_out_w[-1]; 
  assign wire_ctrl_stage4[5] = counter_out_w[-1]; 
  assign wire_ctrl_stage4[6] = counter_out_w[-1]; 
  assign wire_ctrl_stage4[7] = counter_out_w[-1]; 
  assign wire_ctrl_stage4[8] = counter_out_w[-1]; 
  assign wire_ctrl_stage4[9] = counter_out_w[-1]; 
  assign wire_ctrl_stage4[10] = counter_out_w[-1]; 
  assign wire_ctrl_stage4[11] = counter_out_w[-1]; 
  assign wire_ctrl_stage4[12] = counter_out_w[-1]; 
  assign wire_ctrl_stage4[13] = counter_out_w[-1]; 
  assign wire_ctrl_stage4[14] = counter_out_w[-1]; 
  assign wire_ctrl_stage4[15] = counter_out_w[-1]; 
...
module switches_stage_st0_58_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_58_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st2_58_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st3_58_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st4_58_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st4_58_R switch_stage_4(
  ...
  wire [3:0] counter_out_w;
  counter_16 switch_ctrl(.in_start(in_start_stage4), .counter_out(counter_out_w), .clk(clk), .rst(rst));
  ...
  switches_stage_st3_58_R switch_stage_3(
  ...
  switches_stage_st2_58_R switch_stage_2(
  ...
  switches_stage_st1_58_R switch_stage_1(
  ...
  switches_stage_st0_58_R switch_stage_0(
...
module  mem_addr_gen_dp32_mem0_per58(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  assign addr_out[3:2] = ms_word_high_w[1:0];    
  assign addr_out[1:0] = {ms_word_low_w[0],ms_word_low_w[1]};   
  
  assign ms_word_low_w = counter_in[1:0]; 
  assign ms_word_high_w = counter_in[3:2]; 
    
endmodule                        


module  mem_addr_ctrl_dp32_per58(
in_start,                          
wen_out,                         
out_start,                         
mem_addr_out_0,                         
...
rst                              
  ...
  output [3:0] mem_addr_out_8;            
  output [3:0] mem_addr_out_9;            
  output [3:0] mem_addr_out_10;            
  output [3:0] mem_addr_out_11;            
  output [3:0] mem_addr_out_12;            
  output [3:0] mem_addr_out_13;            
  output [3:0] mem_addr_out_14;            
  output [3:0] mem_addr_out_15;            
  output [3:0] mem_addr_out_16;            
  output [3:0] mem_addr_out_17;            
  output [3:0] mem_addr_out_18;            
  output [3:0] mem_addr_out_19;            
  output [3:0] mem_addr_out_20;            
  output [3:0] mem_addr_out_21;            
  output [3:0] mem_addr_out_22;            
  output [3:0] mem_addr_out_23;            
  output [3:0] mem_addr_out_24;            
  output [3:0] mem_addr_out_25;            
  output [3:0] mem_addr_out_26;            
  output [3:0] mem_addr_out_27;            
  output [3:0] mem_addr_out_28;            
  output [3:0] mem_addr_out_29;            
  output [3:0] mem_addr_out_30;            
  output [3:0] mem_addr_out_31;            
  output wen_out;
  output out_start;
  ...
  wire [3:0] mem_addr_out_tmp_8;   
  wire [3:0] mem_addr_out_tmp_9;   
  wire [3:0] mem_addr_out_tmp_10;   
  wire [3:0] mem_addr_out_tmp_11;   
  wire [3:0] mem_addr_out_tmp_12;   
  wire [3:0] mem_addr_out_tmp_13;   
  wire [3:0] mem_addr_out_tmp_14;   
  wire [3:0] mem_addr_out_tmp_15;   
  wire [3:0] mem_addr_out_tmp_16;   
  wire [3:0] mem_addr_out_tmp_17;   
  wire [3:0] mem_addr_out_tmp_18;   
  wire [3:0] mem_addr_out_tmp_19;   
  wire [3:0] mem_addr_out_tmp_20;   
  wire [3:0] mem_addr_out_tmp_21;   
  wire [3:0] mem_addr_out_tmp_22;   
  wire [3:0] mem_addr_out_tmp_23;   
  wire [3:0] mem_addr_out_tmp_24;   
  wire [3:0] mem_addr_out_tmp_25;   
  wire [3:0] mem_addr_out_tmp_26;   
  wire [3:0] mem_addr_out_tmp_27;   
  wire [3:0] mem_addr_out_tmp_28;   
  wire [3:0] mem_addr_out_tmp_29;   
  wire [3:0] mem_addr_out_tmp_30;   
  wire [3:0] mem_addr_out_tmp_31;   
  wire [3:0] mem_addr_out_w;        
  wire [4:0] mem_addr_out_w_h;        
  
  mem_addr_gen_dp32_mem0_per58 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter)); 
  ...
  assign out_start = (state == 2'b01) && (counter[3:0] == {4{1'b1}}); 
    ...
    if(rst) begin                    
      ...
      case (state)              
        ...
        2'b01: begin              
          ...
          if (!in_start && counter == {4{1'b1}})  begin 
            state <= 2'b11;              
          end
