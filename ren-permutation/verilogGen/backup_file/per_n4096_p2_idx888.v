...
module  mem_addr_gen_dp2_mem0_per888(
counter_in,                              
clk,                             
rst,                             
addr_out                            
...
module  mem_addr_ctrl_dp2_per888(
in_start,                          
counter_in,                         
wen_out,                         
out_start,                         
...
rst                              
  ...
  mem_addr_gen_dp2_mem0_per888 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter_in)); 
...
rst                              
  ...
  mem_addr_ctrl_dp2_per888 addr_gen_inst(.in_start(in_start), .counter_in(counter_in), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .clk(clk), .rst(rst));
