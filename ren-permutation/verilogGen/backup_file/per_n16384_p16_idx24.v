...
module switches_stage_st0_24_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_24_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st2_24_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st3_24_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st0_24_L switch_stage_0(
  ...
  assign wire_ctrl_stage0[0] = counter_w[9]; 
  assign wire_ctrl_stage0[1] = counter_w[9]; 
  assign wire_ctrl_stage0[2] = counter_w[9]; 
  assign wire_ctrl_stage0[3] = counter_w[9]; 
  assign wire_ctrl_stage0[4] = counter_w[9]; 
  assign wire_ctrl_stage0[5] = counter_w[9]; 
  assign wire_ctrl_stage0[6] = counter_w[9]; 
  assign wire_ctrl_stage0[7] = counter_w[9]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage1[15:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage1[15:0];
  wire [7:0] wire_ctrl_stage1;

  switches_stage_st1_24_L switch_stage_1(
  ...
  assign wire_ctrl_stage1[0] = counter_w[8]; 
  assign wire_ctrl_stage1[1] = counter_w[8]; 
  assign wire_ctrl_stage1[2] = counter_w[8]; 
  assign wire_ctrl_stage1[3] = counter_w[8]; 
  assign wire_ctrl_stage1[4] = counter_w[8]; 
  assign wire_ctrl_stage1[5] = counter_w[8]; 
  assign wire_ctrl_stage1[6] = counter_w[8]; 
  assign wire_ctrl_stage1[7] = counter_w[8]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage2[15:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage2[15:0];
  wire [7:0] wire_ctrl_stage2;

  switches_stage_st2_24_L switch_stage_2(
  ...
  assign wire_ctrl_stage2[0] = counter_w[7]; 
  assign wire_ctrl_stage2[1] = counter_w[7]; 
  assign wire_ctrl_stage2[2] = counter_w[7]; 
  assign wire_ctrl_stage2[3] = counter_w[7]; 
  assign wire_ctrl_stage2[4] = counter_w[7]; 
  assign wire_ctrl_stage2[5] = counter_w[7]; 
  assign wire_ctrl_stage2[6] = counter_w[7]; 
  assign wire_ctrl_stage2[7] = counter_w[7]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage3[15:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage3[15:0];
  wire [7:0] wire_ctrl_stage3;

  switches_stage_st3_24_L switch_stage_3(
  ...
  assign wire_ctrl_stage3[0] = counter_w[6]; 
  assign wire_ctrl_stage3[1] = counter_w[6]; 
  assign wire_ctrl_stage3[2] = counter_w[6]; 
  assign wire_ctrl_stage3[3] = counter_w[6]; 
  assign wire_ctrl_stage3[4] = counter_w[6]; 
  assign wire_ctrl_stage3[5] = counter_w[6]; 
  assign wire_ctrl_stage3[6] = counter_w[6]; 
  assign wire_ctrl_stage3[7] = counter_w[6]; 
...
module switches_stage_st0_24_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_24_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st2_24_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st3_24_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st3_24_R switch_stage_3(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[0] <= counter_w[6]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[1] <= counter_w[6]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[2] <= counter_w[6]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[3] <= counter_w[6]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[4] <= counter_w[6]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[5] <= counter_w[6]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[6] <= counter_w[6]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[7] <= counter_w[6]; 
  end                            
  ...
  switches_stage_st2_24_R switch_stage_2(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[0] <= counter_w[7]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[1] <= counter_w[7]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[2] <= counter_w[7]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[3] <= counter_w[7]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[4] <= counter_w[7]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[5] <= counter_w[7]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[6] <= counter_w[7]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[7] <= counter_w[7]; 
  end                            
  ...
  switches_stage_st1_24_R switch_stage_1(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[0] <= counter_w[8]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[1] <= counter_w[8]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[2] <= counter_w[8]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[3] <= counter_w[8]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[4] <= counter_w[8]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[5] <= counter_w[8]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[6] <= counter_w[8]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[7] <= counter_w[8]; 
  end                            
  ...
  switches_stage_st0_24_R switch_stage_0(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[0] <= counter_w[9]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[1] <= counter_w[9]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[2] <= counter_w[9]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[3] <= counter_w[9]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[4] <= counter_w[9]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[5] <= counter_w[9]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[6] <= counter_w[9]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[7] <= counter_w[9]; 
  end                            
...
module  mem_addr_gen_dp16_mem0_per24(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  assign addr_out[9:6] = addr_a0[3:0];   
  
  assign word_counter_w[0] = counter_in[5:2];  
  assign addr_a0 = counter_in[9:6]; 
  assign addr_a1 = counter_in[1:0]; 
    
endmodule                        


module  mem_addr_ctrl_dp16_per24(
in_start,                          
counter_in,                         
wen_out,                         
out_start,                         
...
rst                              
  ...
  mem_addr_gen_dp16_mem0_per24 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter_in)); 
  ...
  begin                            
    if(rst) begin                    
      ...
      out_start <= (state == 2'b01) && (counter_in[9:0] == {10{1'b1}}); 
end                              
end                              
  ...
  begin                            
    if(rst) begin                    
      ...
      case (state)              
        ...
        2'b01: begin              
          if (!in_start && counter_in == {10{1'b1}})  begin 
            state <= 2'b11;              
          end
          if (counter_in == {10{1'b1}})  begin 
            flag <= !flag;              
          end
        end
        2'b11: begin              
...
rst                              
  ...
  wire [9:0] addr_wire_0;        

  wire [9:0] addr_wire_1;        

  wire [9:0] addr_wire_2;        

  wire [9:0] addr_wire_3;        

  wire [9:0] addr_wire_4;        

  wire [9:0] addr_wire_5;        

  wire [9:0] addr_wire_6;        

  wire [9:0] addr_wire_7;        

  wire [9:0] addr_wire_8;        

  wire [9:0] addr_wire_9;        

  wire [9:0] addr_wire_10;        

  wire [9:0] addr_wire_11;        

  wire [9:0] addr_wire_12;        

  wire [9:0] addr_wire_13;        

  wire [9:0] addr_wire_14;        

  wire [9:0] addr_wire_15;        

  mem_addr_ctrl_dp16_per24 addr_gen_inst(.in_start(in_start), .counter_in(counter_in), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .mem_addr_out_2(addr_wire_2), .mem_addr_out_3(addr_wire_3), .mem_addr_out_4(addr_wire_4), .mem_addr_out_5(addr_wire_5), .mem_addr_out_6(addr_wire_6), .mem_addr_out_7(addr_wire_7), .mem_addr_out_8(addr_wire_8), .mem_addr_out_9(addr_wire_9), .mem_addr_out_10(addr_wire_10), .mem_addr_out_11(addr_wire_11), .mem_addr_out_12(addr_wire_12), .mem_addr_out_13(addr_wire_13), .mem_addr_out_14(addr_wire_14), .mem_addr_out_15(addr_wire_15), .clk(clk), .rst(rst));

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(10)) 
...
rst                              
  ...
  counter_2048 ctrl_unit(.in_start(in_start), .counter_out(counter_out_w), .clk(clk), .rst(rst));
