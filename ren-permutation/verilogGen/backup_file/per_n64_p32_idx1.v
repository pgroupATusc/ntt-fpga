...
rst                              
  ...
  assign wireOut[1] = wireIn[1]; assign wireOut[0]= wireIn[0]; assign wireOut[3] = wireIn[3]; assign wireOut[2]= wireIn[2]; assign wireOut[5] = wireIn[5]; assign wireOut[4]= wireIn[4]; assign wireOut[7] = wireIn[7]; assign wireOut[6]= wireIn[6]; assign wireOut[8] = wireIn[9]; assign wireOut[9]= wireIn[8]; assign wireOut[10] = wireIn[11]; assign wireOut[11]= wireIn[10]; assign wireOut[12] = wireIn[13]; assign wireOut[13]= wireIn[12]; assign wireOut[14] = wireIn[15]; assign wireOut[15]= wireIn[14]; assign wireOut[17] = wireIn[17]; assign wireOut[16]= wireIn[16]; assign wireOut[19] = wireIn[19]; assign wireOut[18]= wireIn[18]; assign wireOut[21] = wireIn[21]; assign wireOut[20]= wireIn[20]; assign wireOut[23] = wireIn[23]; assign wireOut[22]= wireIn[22]; assign wireOut[24] = wireIn[25]; assign wireOut[25]= wireIn[24]; assign wireOut[26] = wireIn[27]; assign wireOut[27]= wireIn[26]; assign wireOut[28] = wireIn[29]; assign wireOut[29]= wireIn[28]; assign wireOut[30] = wireIn[31]; assign wireOut[31]= wireIn[30]; 
  assign outData_0 = wireOut[0];    
  assign outData_1 = wireOut[1];    
  assign outData_2 = wireOut[2];    
  assign outData_3 = wireOut[3];    
...
rst                              
  ...
  assign wireOut[30] = wireIn[31]; assign wireOut[31]= wireIn[30]; 
  assign outData_0 = wireOut[0];    
  assign outData_1 = wireOut[1];    
  assign outData_2 = wireOut[2];    
  assign outData_3 = wireOut[3];    
...
rst                              
  ...
  counter_2 switch_ctrl(.in_start(in_start_stage0), .counter_out(counter_out_w), .clk(clk), .rst(rst));

  assign wire_ctrl_stage0[0] = counter_out_w[0]; 
  assign wire_ctrl_stage0[1] = counter_out_w[0]; 
  assign wire_ctrl_stage0[2] = counter_out_w[0]; 
  assign wire_ctrl_stage0[3] = counter_out_w[0]; 
  assign wire_ctrl_stage0[4] = counter_out_w[0]; 
  assign wire_ctrl_stage0[5] = counter_out_w[0]; 
  assign wire_ctrl_stage0[6] = counter_out_w[0]; 
  assign wire_ctrl_stage0[7] = counter_out_w[0]; 
  assign wire_ctrl_stage0[8] = counter_out_w[0]; 
  assign wire_ctrl_stage0[9] = counter_out_w[0]; 
  assign wire_ctrl_stage0[10] = counter_out_w[0]; 
  assign wire_ctrl_stage0[11] = counter_out_w[0]; 
  assign wire_ctrl_stage0[12] = counter_out_w[0]; 
  assign wire_ctrl_stage0[13] = counter_out_w[0]; 
  assign wire_ctrl_stage0[14] = counter_out_w[0]; 
  assign wire_ctrl_stage0[15] = counter_out_w[0]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage1[31:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage1[31:0];
  wire [15:0] wire_ctrl_stage1;

  switches_stage_st1_1_L switch_stage_1(
  ...
  switches_stage_st2_1_L switch_stage_2(
  ...
  assign wire_ctrl_stage2[0] = counter_out_w[-2]; 
  assign wire_ctrl_stage2[1] = counter_out_w[-2]; 
  assign wire_ctrl_stage2[2] = counter_out_w[-2]; 
  assign wire_ctrl_stage2[3] = counter_out_w[-2]; 
  assign wire_ctrl_stage2[4] = counter_out_w[-2]; 
  assign wire_ctrl_stage2[5] = counter_out_w[-2]; 
  assign wire_ctrl_stage2[6] = counter_out_w[-2]; 
  assign wire_ctrl_stage2[7] = counter_out_w[-2]; 
  assign wire_ctrl_stage2[8] = counter_out_w[-2]; 
  assign wire_ctrl_stage2[9] = counter_out_w[-2]; 
  assign wire_ctrl_stage2[10] = counter_out_w[-2]; 
  assign wire_ctrl_stage2[11] = counter_out_w[-2]; 
  assign wire_ctrl_stage2[12] = counter_out_w[-2]; 
  assign wire_ctrl_stage2[13] = counter_out_w[-2]; 
  assign wire_ctrl_stage2[14] = counter_out_w[-2]; 
  assign wire_ctrl_stage2[15] = counter_out_w[-2]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage3[31:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage3[31:0];
  wire [15:0] wire_ctrl_stage3;

  switches_stage_st3_1_L switch_stage_3(
  ...
  switches_stage_st4_1_L switch_stage_4(
...
rst                              
  ...
  switches_stage_st4_1_R switch_stage_4(
  ...
  wire [0:0] counter_out_w;
  counter_2 switch_ctrl(.in_start(in_start_stage4), .counter_out(counter_out_w), .clk(clk), .rst(rst));
  ...
  switches_stage_st3_1_R switch_stage_3(
  ...
  switches_stage_st2_1_R switch_stage_2(
  ...
  switches_stage_st1_1_R switch_stage_1(
...
module  mem_addr_gen_dp32_mem0_per1(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  assign addr_out[0:-1] = ms_word_high_w[1:0];    
...
module  mem_addr_ctrl_dp32_per1(
in_start,                          
wen_out,                         
out_start,                         
mem_addr_out_0,                         
...
rst                              
  ...
  output [0:0] mem_addr_out_8;            
  output [0:0] mem_addr_out_9;            
  output [0:0] mem_addr_out_10;            
  output [0:0] mem_addr_out_11;            
  output [0:0] mem_addr_out_12;            
  output [0:0] mem_addr_out_13;            
  output [0:0] mem_addr_out_14;            
  output [0:0] mem_addr_out_15;            
  output [0:0] mem_addr_out_16;            
  output [0:0] mem_addr_out_17;            
  output [0:0] mem_addr_out_18;            
  output [0:0] mem_addr_out_19;            
  output [0:0] mem_addr_out_20;            
  output [0:0] mem_addr_out_21;            
  output [0:0] mem_addr_out_22;            
  output [0:0] mem_addr_out_23;            
  output [0:0] mem_addr_out_24;            
  output [0:0] mem_addr_out_25;            
  output [0:0] mem_addr_out_26;            
  output [0:0] mem_addr_out_27;            
  output [0:0] mem_addr_out_28;            
  output [0:0] mem_addr_out_29;            
  output [0:0] mem_addr_out_30;            
  output [0:0] mem_addr_out_31;            
  output wen_out;
  output out_start;
  ...
  wire [0:0] mem_addr_out_tmp_8;   
  wire [0:0] mem_addr_out_tmp_9;   
  wire [0:0] mem_addr_out_tmp_10;   
  wire [0:0] mem_addr_out_tmp_11;   
  wire [0:0] mem_addr_out_tmp_12;   
  wire [0:0] mem_addr_out_tmp_13;   
  wire [0:0] mem_addr_out_tmp_14;   
  wire [0:0] mem_addr_out_tmp_15;   
  wire [0:0] mem_addr_out_tmp_16;   
  wire [0:0] mem_addr_out_tmp_17;   
  wire [0:0] mem_addr_out_tmp_18;   
  wire [0:0] mem_addr_out_tmp_19;   
  wire [0:0] mem_addr_out_tmp_20;   
  wire [0:0] mem_addr_out_tmp_21;   
  wire [0:0] mem_addr_out_tmp_22;   
  wire [0:0] mem_addr_out_tmp_23;   
  wire [0:0] mem_addr_out_tmp_24;   
  wire [0:0] mem_addr_out_tmp_25;   
  wire [0:0] mem_addr_out_tmp_26;   
  wire [0:0] mem_addr_out_tmp_27;   
  wire [0:0] mem_addr_out_tmp_28;   
  wire [0:0] mem_addr_out_tmp_29;   
  wire [0:0] mem_addr_out_tmp_30;   
  wire [0:0] mem_addr_out_tmp_31;   
  wire [0:0] mem_addr_out_w;        
  wire [4:0] mem_addr_out_w_h;        
  
  mem_addr_gen_dp32_mem0_per1 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter)); 

  assign mem_addr_out_w_h = mem_addr_out_w[0:-4];        
  ...
  assign out_start = (state == 2'b01) && (counter[0:0] == {1{1'b1}}); 
    ...
    if(rst) begin                    
      ...
      case (state)              
        ...
        2'b01: begin              
          ...
          if (!in_start && counter == {1{1'b1}})  begin 
            state <= 2'b11;              
          end
