...
module switches_stage_st0_28_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_28_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st0_28_L switch_stage_0(
  ...
  switches_stage_st1_28_L switch_stage_1(
...
module switches_stage_st0_28_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_28_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st1_28_R switch_stage_1(
  ...
  wire [6:0] counter_out_w;
  counter_128 switch_ctrl(.in_start(in_start_stage1), .counter_out(counter_out_w), .clk(clk), .rst(rst));
  ...
  switches_stage_st0_28_R switch_stage_0(
...
module  mem_addr_gen_dp4_mem0_per28(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  assign ms_word_low_w = counter_in[4:3]; 
  assign ms_word_high_w = counter_in[3:2]; 
    
endmodule                        


module  mem_addr_ctrl_dp4_per28(
in_start,                          
wen_out,                         
out_start,                         
mem_addr_out_0,                         
...
rst                              
  ...
  mem_addr_gen_dp4_mem0_per28 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter)); 

  assign mem_addr_out_w_h = mem_addr_out_w[6:5];        
...
rst                              
  ...
  mem_addr_ctrl_dp4_per28 addr_gen_inst(.in_start(in_start), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .mem_addr_out_2(addr_wire_2), .mem_addr_out_3(addr_wire_3), .clk(clk), .rst(rst));
