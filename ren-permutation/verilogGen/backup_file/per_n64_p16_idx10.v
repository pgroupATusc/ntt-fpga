...
module switches_stage_st0_10_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_10_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st2_10_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st3_10_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st0_10_L switch_stage_0(
  ...
  counter_4 switch_ctrl(.in_start(in_start_stage0), .counter_out(counter_out_w), .clk(clk), .rst(rst));

  assign wire_ctrl_stage0[0] = counter_out_w[1]; 
  assign wire_ctrl_stage0[1] = counter_out_w[1]; 
  assign wire_ctrl_stage0[2] = counter_out_w[1]; 
  assign wire_ctrl_stage0[3] = counter_out_w[1]; 
  assign wire_ctrl_stage0[4] = counter_out_w[1]; 
  assign wire_ctrl_stage0[5] = counter_out_w[1]; 
  assign wire_ctrl_stage0[6] = counter_out_w[1]; 
  assign wire_ctrl_stage0[7] = counter_out_w[1]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage1[15:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage1[15:0];
  wire [7:0] wire_ctrl_stage1;

  switches_stage_st1_10_L switch_stage_1(
  ...
  assign wire_ctrl_stage1[0] = counter_out_w[0]; 
  assign wire_ctrl_stage1[1] = counter_out_w[0]; 
  assign wire_ctrl_stage1[2] = counter_out_w[0]; 
  assign wire_ctrl_stage1[3] = counter_out_w[0]; 
  assign wire_ctrl_stage1[4] = counter_out_w[0]; 
  assign wire_ctrl_stage1[5] = counter_out_w[0]; 
  assign wire_ctrl_stage1[6] = counter_out_w[0]; 
  assign wire_ctrl_stage1[7] = counter_out_w[0]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage2[15:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage2[15:0];
  wire [7:0] wire_ctrl_stage2;

  switches_stage_st2_10_L switch_stage_2(
  ...
  switches_stage_st3_10_L switch_stage_3(
  ...
  assign wire_ctrl_stage3[0] = counter_out_w[-2]; 
  assign wire_ctrl_stage3[1] = counter_out_w[-2]; 
  assign wire_ctrl_stage3[2] = counter_out_w[-2]; 
  assign wire_ctrl_stage3[3] = counter_out_w[-2]; 
  assign wire_ctrl_stage3[4] = counter_out_w[-2]; 
  assign wire_ctrl_stage3[5] = counter_out_w[-2]; 
  assign wire_ctrl_stage3[6] = counter_out_w[-2]; 
  assign wire_ctrl_stage3[7] = counter_out_w[-2]; 
...
module switches_stage_st0_10_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_10_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st2_10_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st3_10_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st3_10_R switch_stage_3(
  ...
  wire [1:0] counter_out_w;
  counter_4 switch_ctrl(.in_start(in_start_stage3), .counter_out(counter_out_w), .clk(clk), .rst(rst));
  ...
  switches_stage_st2_10_R switch_stage_2(
  ...
  switches_stage_st1_10_R switch_stage_1(
  ...
  switches_stage_st0_10_R switch_stage_0(
...
module  mem_addr_gen_dp16_mem0_per10(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  assign addr_out[1:0] = ms_word_low_w[1:0];   
...
module  mem_addr_ctrl_dp16_per10(
in_start,                          
wen_out,                         
out_start,                         
mem_addr_out_0,                         
...
rst                              
  ...
  output [1:0] mem_addr_out_4;            
  output [1:0] mem_addr_out_5;            
  output [1:0] mem_addr_out_6;            
  output [1:0] mem_addr_out_7;            
  output [1:0] mem_addr_out_8;            
  output [1:0] mem_addr_out_9;            
  output [1:0] mem_addr_out_10;            
  output [1:0] mem_addr_out_11;            
  output [1:0] mem_addr_out_12;            
  output [1:0] mem_addr_out_13;            
  output [1:0] mem_addr_out_14;            
  output [1:0] mem_addr_out_15;            
  output wen_out;
  output out_start;
  ...
  wire [1:0] mem_addr_out_tmp_4;   
  wire [1:0] mem_addr_out_tmp_5;   
  wire [1:0] mem_addr_out_tmp_6;   
  wire [1:0] mem_addr_out_tmp_7;   
  wire [1:0] mem_addr_out_tmp_8;   
  wire [1:0] mem_addr_out_tmp_9;   
  wire [1:0] mem_addr_out_tmp_10;   
  wire [1:0] mem_addr_out_tmp_11;   
  wire [1:0] mem_addr_out_tmp_12;   
  wire [1:0] mem_addr_out_tmp_13;   
  wire [1:0] mem_addr_out_tmp_14;   
  wire [1:0] mem_addr_out_tmp_15;   
  wire [1:0] mem_addr_out_w;        
  wire [3:0] mem_addr_out_w_h;        
  
  mem_addr_gen_dp16_mem0_per10 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter)); 

  assign mem_addr_out_w_h = mem_addr_out_w[1:-2];        
  assign mem_addr_out_tmp_0 = {mem_addr_out_w_h[3],mem_addr_out_w_h[2],mem_addr_out_w_h[1],mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_1 = {mem_addr_out_w_h[3],mem_addr_out_w_h[2],mem_addr_out_w_h[1],~mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_2 = {mem_addr_out_w_h[3],mem_addr_out_w_h[2],~mem_addr_out_w_h[1],mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_3 = {mem_addr_out_w_h[3],mem_addr_out_w_h[2],~mem_addr_out_w_h[1],~mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_4 = {mem_addr_out_w_h[3],~mem_addr_out_w_h[2],mem_addr_out_w_h[1],mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_5 = {mem_addr_out_w_h[3],~mem_addr_out_w_h[2],mem_addr_out_w_h[1],~mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_6 = {mem_addr_out_w_h[3],~mem_addr_out_w_h[2],~mem_addr_out_w_h[1],mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_7 = {mem_addr_out_w_h[3],~mem_addr_out_w_h[2],~mem_addr_out_w_h[1],~mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_8 = {~mem_addr_out_w_h[3],mem_addr_out_w_h[2],mem_addr_out_w_h[1],mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_9 = {~mem_addr_out_w_h[3],mem_addr_out_w_h[2],mem_addr_out_w_h[1],~mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_10 = {~mem_addr_out_w_h[3],mem_addr_out_w_h[2],~mem_addr_out_w_h[1],mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_11 = {~mem_addr_out_w_h[3],mem_addr_out_w_h[2],~mem_addr_out_w_h[1],~mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_12 = {~mem_addr_out_w_h[3],~mem_addr_out_w_h[2],mem_addr_out_w_h[1],mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_13 = {~mem_addr_out_w_h[3],~mem_addr_out_w_h[2],mem_addr_out_w_h[1],~mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_14 = {~mem_addr_out_w_h[3],~mem_addr_out_w_h[2],~mem_addr_out_w_h[1],mem_addr_out_w_h[0]}; 
  assign mem_addr_out_tmp_15 = {~mem_addr_out_w_h[3],~mem_addr_out_w_h[2],~mem_addr_out_w_h[1],~mem_addr_out_w_h[0]}; 
  ...
  assign out_start = (state == 2'b01) && (counter[1:0] == {2{1'b1}}); 
    ...
    if(rst) begin                    
      ...
      case (state)              
        ...
        2'b01: begin              
          ...
          if (!in_start && counter == {2{1'b1}})  begin 
            state <= 2'b11;              
          end
