...
rst                              
  ...
  wire [1:0] counter_out_w;
  counter_4 switch_ctrl(.in_start(in_start_stage1), .counter_out(counter_out_w), .clk(clk), .rst(rst));
...
rst                              
  ...
  mem_addr_gen_dp4_mem0_per0 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter)); 
...
rst                              
  ...
  mem_addr_ctrl_dp4_per0 addr_gen_inst(.in_start(in_start), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .mem_addr_out_2(addr_wire_2), .mem_addr_out_3(addr_wire_3), .clk(clk), .rst(rst));
