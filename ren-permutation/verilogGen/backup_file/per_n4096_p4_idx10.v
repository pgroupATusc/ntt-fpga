...
module  mem_addr_gen_dp4_mem0_per10(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  assign addr_out[9:8] = addr_a0[1:0];   
  
  assign word_counter_w[0] = counter_in[3:0];  
  assign word_counter_w[1] = counter_in[7:4];  
  assign addr_a0 = counter_in[9:8]; 
  
endmodule                        


module  mem_addr_ctrl_dp4_per10(
in_start,                          
counter_in,                         
wen_out,                         
out_start,                         
...
rst                              
  ...
  mem_addr_gen_dp4_mem0_per10 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter_in)); 

  assign mem_addr_out_w_h = mem_addr_out_w[9:8];        
...
rst                              
  ...
  mem_addr_ctrl_dp4_per10 addr_gen_inst(.in_start(in_start), .counter_in(counter_in), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .mem_addr_out_2(addr_wire_2), .mem_addr_out_3(addr_wire_3), .clk(clk), .rst(rst));
