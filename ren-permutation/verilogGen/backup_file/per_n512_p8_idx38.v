...
module switches_stage_st0_38_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_38_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st2_38_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st0_38_L switch_stage_0(
  ...
  counter_64 switch_ctrl(.in_start(in_start_stage0), .counter_out(counter_out_w), .clk(clk), .rst(rst));

  assign wire_ctrl_stage0[0] = counter_out_w[5]; 
  assign wire_ctrl_stage0[1] = counter_out_w[5]; 
  assign wire_ctrl_stage0[2] = counter_out_w[5]; 
  assign wire_ctrl_stage0[3] = counter_out_w[5]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage1[7:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage1[7:0];
  wire [3:0] wire_ctrl_stage1;

  switches_stage_st1_38_L switch_stage_1(
  ...
  assign wire_ctrl_stage1[0] = counter_out_w[4]; 
  assign wire_ctrl_stage1[1] = counter_out_w[4]; 
  assign wire_ctrl_stage1[2] = counter_out_w[4]; 
  assign wire_ctrl_stage1[3] = counter_out_w[4]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage2[7:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage2[7:0];
  wire [3:0] wire_ctrl_stage2;

  switches_stage_st2_38_L switch_stage_2(
  ...
  assign wire_ctrl_stage2[0] = counter_out_w[3]; 
  assign wire_ctrl_stage2[1] = counter_out_w[3]; 
  assign wire_ctrl_stage2[2] = counter_out_w[3]; 
  assign wire_ctrl_stage2[3] = counter_out_w[3]; 
...
module switches_stage_st0_38_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_38_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st2_38_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st2_38_R switch_stage_2(
  ...
  wire [5:0] counter_out_w;
  counter_64 switch_ctrl(.in_start(in_start_stage2), .counter_out(counter_out_w), .clk(clk), .rst(rst));
  ...
  switches_stage_st1_38_R switch_stage_1(
  ...
  switches_stage_st0_38_R switch_stage_0(
...
module  mem_addr_gen_dp8_mem0_per38(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  assign addr_out[5:4] = ms_word_low_w[1:0];   
  
  assign word_counter_w[0] = counter_in[3:0];  
  assign ms_word_low_w = counter_in[2:1]; 
  assign ms_word_high_w = counter_in[2:1]; 
    
endmodule                        


module  mem_addr_ctrl_dp8_per38(
in_start,                          
wen_out,                         
out_start,                         
mem_addr_out_0,                         
...
rst                              
  ...
  mem_addr_gen_dp8_mem0_per38 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter)); 

  assign mem_addr_out_w_h = mem_addr_out_w[5:3];        
  ...
  assign out_start = (state == 2'b01) && (counter[5:0] == {6{1'b1}}); 
    ...
    if(rst) begin                    
      ...
      case (state)              
        ...
        2'b01: begin              
          ...
          if (!in_start && counter == {6{1'b1}})  begin 
            state <= 2'b11;              
          end
...
rst                              
  ...
  mem_addr_ctrl_dp8_per38 addr_gen_inst(.in_start(in_start), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .mem_addr_out_2(addr_wire_2), .mem_addr_out_3(addr_wire_3), .mem_addr_out_4(addr_wire_4), .mem_addr_out_5(addr_wire_5), .mem_addr_out_6(addr_wire_6), .mem_addr_out_7(addr_wire_7), .clk(clk), .rst(rst));
