...
module  mem_addr_gen_dp2_mem0_per2(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  assign addr_a0 = counter_in[8:8]; 
  
endmodule                        


module  mem_addr_ctrl_dp2_per2(
in_start,                          
counter_in,                         
wen_out,                         
out_start,                         
...
rst                              
  ...
  mem_addr_gen_dp2_mem0_per2 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter_in)); 
...
rst                              
  ...
  mem_addr_ctrl_dp2_per2 addr_gen_inst(.in_start(in_start), .counter_in(counter_in), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .clk(clk), .rst(rst));
