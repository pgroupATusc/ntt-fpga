...
module switches_stage_st0_15_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_15_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st2_15_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st0_15_L switch_stage_0(
  ...
  switches_stage_st1_15_L switch_stage_1(
  ...
  switches_stage_st2_15_L switch_stage_2(
...
module switches_stage_st0_15_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st1_15_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st2_15_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st2_15_R switch_stage_2(
  ...
  switches_stage_st1_15_R switch_stage_1(
  ...
  switches_stage_st0_15_R switch_stage_0(
...
module  mem_addr_gen_dp8_mem0_per15(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  assign addr_out[7:5] = addr_a0[2:0];   
  
  assign word_counter_w[0] = counter_in[4:1];  
  assign addr_a0 = counter_in[7:5]; 
  assign addr_a1 = counter_in[0:0]; 
    
endmodule                        


module  mem_addr_ctrl_dp8_per15(
in_start,                          
counter_in,                         
wen_out,                         
out_start,                         
...
rst                              
  ...
  mem_addr_gen_dp8_mem0_per15 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter_in)); 

  assign mem_addr_out_w_h = mem_addr_out_w[7:5];        
...
rst                              
  ...
  mem_addr_ctrl_dp8_per15 addr_gen_inst(.in_start(in_start), .counter_in(counter_in), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .mem_addr_out_2(addr_wire_2), .mem_addr_out_3(addr_wire_3), .mem_addr_out_4(addr_wire_4), .mem_addr_out_5(addr_wire_5), .mem_addr_out_6(addr_wire_6), .mem_addr_out_7(addr_wire_7), .clk(clk), .rst(rst));
