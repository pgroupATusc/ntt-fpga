...
rst                              
  ...
  switches_stage_st0_4_L switch_stage_0(
  ...
  counter_128 switch_ctrl(.in_start(in_start_stage0), .counter_out(counter_out_w), .clk(clk), .rst(rst));

  assign wire_ctrl_stage0[0] = counter_out_w[6]; 
  assign wire_ctrl_stage0[1] = counter_out_w[6]; 
  assign wire_ctrl_stage0[2] = counter_out_w[6]; 
  assign wire_ctrl_stage0[3] = counter_out_w[6]; 
  assign wire_ctrl_stage0[4] = counter_out_w[6]; 
  assign wire_ctrl_stage0[5] = counter_out_w[6]; 
  assign wire_ctrl_stage0[6] = counter_out_w[6]; 
  assign wire_ctrl_stage0[7] = counter_out_w[6]; 
  assign wire_ctrl_stage0[8] = counter_out_w[6]; 
  assign wire_ctrl_stage0[9] = counter_out_w[6]; 
  assign wire_ctrl_stage0[10] = counter_out_w[6]; 
  assign wire_ctrl_stage0[11] = counter_out_w[6]; 
  assign wire_ctrl_stage0[12] = counter_out_w[6]; 
  assign wire_ctrl_stage0[13] = counter_out_w[6]; 
  assign wire_ctrl_stage0[14] = counter_out_w[6]; 
  assign wire_ctrl_stage0[15] = counter_out_w[6]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage1[31:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage1[31:0];
  wire [15:0] wire_ctrl_stage1;

  switches_stage_st1_4_L switch_stage_1(
  ...
  assign wire_ctrl_stage1[0] = counter_out_w[5]; 
  assign wire_ctrl_stage1[1] = counter_out_w[5]; 
  assign wire_ctrl_stage1[2] = counter_out_w[5]; 
  assign wire_ctrl_stage1[3] = counter_out_w[5]; 
  assign wire_ctrl_stage1[4] = counter_out_w[5]; 
  assign wire_ctrl_stage1[5] = counter_out_w[5]; 
  assign wire_ctrl_stage1[6] = counter_out_w[5]; 
  assign wire_ctrl_stage1[7] = counter_out_w[5]; 
  assign wire_ctrl_stage1[8] = counter_out_w[5]; 
  assign wire_ctrl_stage1[9] = counter_out_w[5]; 
  assign wire_ctrl_stage1[10] = counter_out_w[5]; 
  assign wire_ctrl_stage1[11] = counter_out_w[5]; 
  assign wire_ctrl_stage1[12] = counter_out_w[5]; 
  assign wire_ctrl_stage1[13] = counter_out_w[5]; 
  assign wire_ctrl_stage1[14] = counter_out_w[5]; 
  assign wire_ctrl_stage1[15] = counter_out_w[5]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage2[31:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage2[31:0];
  wire [15:0] wire_ctrl_stage2;

  switches_stage_st2_4_L switch_stage_2(
  ...
  assign wire_ctrl_stage2[0] = counter_out_w[4]; 
  assign wire_ctrl_stage2[1] = counter_out_w[4]; 
  assign wire_ctrl_stage2[2] = counter_out_w[4]; 
  assign wire_ctrl_stage2[3] = counter_out_w[4]; 
  assign wire_ctrl_stage2[4] = counter_out_w[4]; 
  assign wire_ctrl_stage2[5] = counter_out_w[4]; 
  assign wire_ctrl_stage2[6] = counter_out_w[4]; 
  assign wire_ctrl_stage2[7] = counter_out_w[4]; 
  assign wire_ctrl_stage2[8] = counter_out_w[4]; 
  assign wire_ctrl_stage2[9] = counter_out_w[4]; 
  assign wire_ctrl_stage2[10] = counter_out_w[4]; 
  assign wire_ctrl_stage2[11] = counter_out_w[4]; 
  assign wire_ctrl_stage2[12] = counter_out_w[4]; 
  assign wire_ctrl_stage2[13] = counter_out_w[4]; 
  assign wire_ctrl_stage2[14] = counter_out_w[4]; 
  assign wire_ctrl_stage2[15] = counter_out_w[4]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage3[31:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage3[31:0];
  wire [15:0] wire_ctrl_stage3;

  switches_stage_st3_4_L switch_stage_3(
  ...
  assign wire_ctrl_stage3[0] = counter_out_w[3]; 
  assign wire_ctrl_stage3[1] = counter_out_w[3]; 
  assign wire_ctrl_stage3[2] = counter_out_w[3]; 
  assign wire_ctrl_stage3[3] = counter_out_w[3]; 
  assign wire_ctrl_stage3[4] = counter_out_w[3]; 
  assign wire_ctrl_stage3[5] = counter_out_w[3]; 
  assign wire_ctrl_stage3[6] = counter_out_w[3]; 
  assign wire_ctrl_stage3[7] = counter_out_w[3]; 
  assign wire_ctrl_stage3[8] = counter_out_w[3]; 
  assign wire_ctrl_stage3[9] = counter_out_w[3]; 
  assign wire_ctrl_stage3[10] = counter_out_w[3]; 
  assign wire_ctrl_stage3[11] = counter_out_w[3]; 
  assign wire_ctrl_stage3[12] = counter_out_w[3]; 
  assign wire_ctrl_stage3[13] = counter_out_w[3]; 
  assign wire_ctrl_stage3[14] = counter_out_w[3]; 
  assign wire_ctrl_stage3[15] = counter_out_w[3]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage4[31:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage4[31:0];
  wire [15:0] wire_ctrl_stage4;

  switches_stage_st4_4_L switch_stage_4(
...
rst                              
  ...
  switches_stage_st4_4_R switch_stage_4(
  ...
  wire [6:0] counter_out_w;
  counter_128 switch_ctrl(.in_start(in_start_stage4), .counter_out(counter_out_w), .clk(clk), .rst(rst));
  ...
  switches_stage_st3_4_R switch_stage_3(
  ...
  switches_stage_st2_4_R switch_stage_2(
  ...
  switches_stage_st1_4_R switch_stage_1(
  ...
  switches_stage_st0_4_R switch_stage_0(
...
module  mem_addr_gen_dp32_mem0_per4(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  assign addr_out[6:5] = ms_word_high_w[1:0];    
  assign addr_out[5:4] = {ms_word_low_w[0],ms_word_low_w[1]};   
  
  assign word_counter_w[0] = counter_in[6:3];  
  assign ms_word_low_w = counter_in[1:0]; 
  assign ms_word_high_w = counter_in[1:0]; 
    
endmodule                        


module  mem_addr_ctrl_dp32_per4(
in_start,                          
wen_out,                         
out_start,                         
mem_addr_out_0,                         
...
rst                              
  ...
  output [6:0] mem_addr_out_8;            
  output [6:0] mem_addr_out_9;            
  output [6:0] mem_addr_out_10;            
  output [6:0] mem_addr_out_11;            
  output [6:0] mem_addr_out_12;            
  output [6:0] mem_addr_out_13;            
  output [6:0] mem_addr_out_14;            
  output [6:0] mem_addr_out_15;            
  output [6:0] mem_addr_out_16;            
  output [6:0] mem_addr_out_17;            
  output [6:0] mem_addr_out_18;            
  output [6:0] mem_addr_out_19;            
  output [6:0] mem_addr_out_20;            
  output [6:0] mem_addr_out_21;            
  output [6:0] mem_addr_out_22;            
  output [6:0] mem_addr_out_23;            
  output [6:0] mem_addr_out_24;            
  output [6:0] mem_addr_out_25;            
  output [6:0] mem_addr_out_26;            
  output [6:0] mem_addr_out_27;            
  output [6:0] mem_addr_out_28;            
  output [6:0] mem_addr_out_29;            
  output [6:0] mem_addr_out_30;            
  output [6:0] mem_addr_out_31;            
  output wen_out;
  output out_start;
  ...
  wire [6:0] mem_addr_out_tmp_8;   
  wire [6:0] mem_addr_out_tmp_9;   
  wire [6:0] mem_addr_out_tmp_10;   
  wire [6:0] mem_addr_out_tmp_11;   
  wire [6:0] mem_addr_out_tmp_12;   
  wire [6:0] mem_addr_out_tmp_13;   
  wire [6:0] mem_addr_out_tmp_14;   
  wire [6:0] mem_addr_out_tmp_15;   
  wire [6:0] mem_addr_out_tmp_16;   
  wire [6:0] mem_addr_out_tmp_17;   
  wire [6:0] mem_addr_out_tmp_18;   
  wire [6:0] mem_addr_out_tmp_19;   
  wire [6:0] mem_addr_out_tmp_20;   
  wire [6:0] mem_addr_out_tmp_21;   
  wire [6:0] mem_addr_out_tmp_22;   
  wire [6:0] mem_addr_out_tmp_23;   
  wire [6:0] mem_addr_out_tmp_24;   
  wire [6:0] mem_addr_out_tmp_25;   
  wire [6:0] mem_addr_out_tmp_26;   
  wire [6:0] mem_addr_out_tmp_27;   
  wire [6:0] mem_addr_out_tmp_28;   
  wire [6:0] mem_addr_out_tmp_29;   
  wire [6:0] mem_addr_out_tmp_30;   
  wire [6:0] mem_addr_out_tmp_31;   
  wire [6:0] mem_addr_out_w;        
  wire [4:0] mem_addr_out_w_h;        
  wire [1:0] mem_addr_out_w_l;        
  
  mem_addr_gen_dp32_mem0_per4 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter)); 

  assign mem_addr_out_w_h = mem_addr_out_w[6:2];        
  assign mem_addr_out_w_l = mem_addr_out_w[1:0];   
  assign mem_addr_out_tmp_0 = {mem_addr_out_w_h[4],mem_addr_out_w_h[3],mem_addr_out_w_h[2],mem_addr_out_w_h[1],mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_1 = {mem_addr_out_w_h[4],mem_addr_out_w_h[3],mem_addr_out_w_h[2],mem_addr_out_w_h[1],~mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_2 = {mem_addr_out_w_h[4],mem_addr_out_w_h[3],mem_addr_out_w_h[2],~mem_addr_out_w_h[1],mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_3 = {mem_addr_out_w_h[4],mem_addr_out_w_h[3],mem_addr_out_w_h[2],~mem_addr_out_w_h[1],~mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_4 = {mem_addr_out_w_h[4],mem_addr_out_w_h[3],~mem_addr_out_w_h[2],mem_addr_out_w_h[1],mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_5 = {mem_addr_out_w_h[4],mem_addr_out_w_h[3],~mem_addr_out_w_h[2],mem_addr_out_w_h[1],~mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_6 = {mem_addr_out_w_h[4],mem_addr_out_w_h[3],~mem_addr_out_w_h[2],~mem_addr_out_w_h[1],mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_7 = {mem_addr_out_w_h[4],mem_addr_out_w_h[3],~mem_addr_out_w_h[2],~mem_addr_out_w_h[1],~mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_8 = {mem_addr_out_w_h[4],~mem_addr_out_w_h[3],mem_addr_out_w_h[2],mem_addr_out_w_h[1],mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_9 = {mem_addr_out_w_h[4],~mem_addr_out_w_h[3],mem_addr_out_w_h[2],mem_addr_out_w_h[1],~mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_10 = {mem_addr_out_w_h[4],~mem_addr_out_w_h[3],mem_addr_out_w_h[2],~mem_addr_out_w_h[1],mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_11 = {mem_addr_out_w_h[4],~mem_addr_out_w_h[3],mem_addr_out_w_h[2],~mem_addr_out_w_h[1],~mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_12 = {mem_addr_out_w_h[4],~mem_addr_out_w_h[3],~mem_addr_out_w_h[2],mem_addr_out_w_h[1],mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_13 = {mem_addr_out_w_h[4],~mem_addr_out_w_h[3],~mem_addr_out_w_h[2],mem_addr_out_w_h[1],~mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_14 = {mem_addr_out_w_h[4],~mem_addr_out_w_h[3],~mem_addr_out_w_h[2],~mem_addr_out_w_h[1],mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_15 = {mem_addr_out_w_h[4],~mem_addr_out_w_h[3],~mem_addr_out_w_h[2],~mem_addr_out_w_h[1],~mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_16 = {~mem_addr_out_w_h[4],mem_addr_out_w_h[3],mem_addr_out_w_h[2],mem_addr_out_w_h[1],mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_17 = {~mem_addr_out_w_h[4],mem_addr_out_w_h[3],mem_addr_out_w_h[2],mem_addr_out_w_h[1],~mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_18 = {~mem_addr_out_w_h[4],mem_addr_out_w_h[3],mem_addr_out_w_h[2],~mem_addr_out_w_h[1],mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_19 = {~mem_addr_out_w_h[4],mem_addr_out_w_h[3],mem_addr_out_w_h[2],~mem_addr_out_w_h[1],~mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_20 = {~mem_addr_out_w_h[4],mem_addr_out_w_h[3],~mem_addr_out_w_h[2],mem_addr_out_w_h[1],mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_21 = {~mem_addr_out_w_h[4],mem_addr_out_w_h[3],~mem_addr_out_w_h[2],mem_addr_out_w_h[1],~mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_22 = {~mem_addr_out_w_h[4],mem_addr_out_w_h[3],~mem_addr_out_w_h[2],~mem_addr_out_w_h[1],mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_23 = {~mem_addr_out_w_h[4],mem_addr_out_w_h[3],~mem_addr_out_w_h[2],~mem_addr_out_w_h[1],~mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_24 = {~mem_addr_out_w_h[4],~mem_addr_out_w_h[3],mem_addr_out_w_h[2],mem_addr_out_w_h[1],mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_25 = {~mem_addr_out_w_h[4],~mem_addr_out_w_h[3],mem_addr_out_w_h[2],mem_addr_out_w_h[1],~mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_26 = {~mem_addr_out_w_h[4],~mem_addr_out_w_h[3],mem_addr_out_w_h[2],~mem_addr_out_w_h[1],mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_27 = {~mem_addr_out_w_h[4],~mem_addr_out_w_h[3],mem_addr_out_w_h[2],~mem_addr_out_w_h[1],~mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_28 = {~mem_addr_out_w_h[4],~mem_addr_out_w_h[3],~mem_addr_out_w_h[2],mem_addr_out_w_h[1],mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_29 = {~mem_addr_out_w_h[4],~mem_addr_out_w_h[3],~mem_addr_out_w_h[2],mem_addr_out_w_h[1],~mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_30 = {~mem_addr_out_w_h[4],~mem_addr_out_w_h[3],~mem_addr_out_w_h[2],~mem_addr_out_w_h[1],mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  assign mem_addr_out_tmp_31 = {~mem_addr_out_w_h[4],~mem_addr_out_w_h[3],~mem_addr_out_w_h[2],~mem_addr_out_w_h[1],~mem_addr_out_w_h[0],mem_addr_out_w_l}; 
  ...
  assign out_start = (state == 2'b01) && (counter[6:0] == {7{1'b1}}); 
    ...
    if(rst) begin                    
      ...
      case (state)              
        ...
        2'b01: begin              
          ...
          if (!in_start && counter == {7{1'b1}})  begin 
            state <= 2'b11;              
          end
...
rst                              
  ...
  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_8(.wen(wen_wire), .en(1'b1), .addr(addr_wire_8), .din(wire_in[8]), .dout(wire_out[8]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_9(.wen(wen_wire), .en(1'b1), .addr(addr_wire_9), .din(wire_in[9]), .dout(wire_out[9]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_10(.wen(wen_wire), .en(1'b1), .addr(addr_wire_10), .din(wire_in[10]), .dout(wire_out[10]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_11(.wen(wen_wire), .en(1'b1), .addr(addr_wire_11), .din(wire_in[11]), .dout(wire_out[11]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_12(.wen(wen_wire), .en(1'b1), .addr(addr_wire_12), .din(wire_in[12]), .dout(wire_out[12]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_13(.wen(wen_wire), .en(1'b1), .addr(addr_wire_13), .din(wire_in[13]), .dout(wire_out[13]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_14(.wen(wen_wire), .en(1'b1), .addr(addr_wire_14), .din(wire_in[14]), .dout(wire_out[14]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_15(.wen(wen_wire), .en(1'b1), .addr(addr_wire_15), .din(wire_in[15]), .dout(wire_out[15]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_16(.wen(wen_wire), .en(1'b1), .addr(addr_wire_16), .din(wire_in[16]), .dout(wire_out[16]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_17(.wen(wen_wire), .en(1'b1), .addr(addr_wire_17), .din(wire_in[17]), .dout(wire_out[17]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_18(.wen(wen_wire), .en(1'b1), .addr(addr_wire_18), .din(wire_in[18]), .dout(wire_out[18]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_19(.wen(wen_wire), .en(1'b1), .addr(addr_wire_19), .din(wire_in[19]), .dout(wire_out[19]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_20(.wen(wen_wire), .en(1'b1), .addr(addr_wire_20), .din(wire_in[20]), .dout(wire_out[20]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_21(.wen(wen_wire), .en(1'b1), .addr(addr_wire_21), .din(wire_in[21]), .dout(wire_out[21]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_22(.wen(wen_wire), .en(1'b1), .addr(addr_wire_22), .din(wire_in[22]), .dout(wire_out[22]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_23(.wen(wen_wire), .en(1'b1), .addr(addr_wire_23), .din(wire_in[23]), .dout(wire_out[23]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_24(.wen(wen_wire), .en(1'b1), .addr(addr_wire_24), .din(wire_in[24]), .dout(wire_out[24]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_25(.wen(wen_wire), .en(1'b1), .addr(addr_wire_25), .din(wire_in[25]), .dout(wire_out[25]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_26(.wen(wen_wire), .en(1'b1), .addr(addr_wire_26), .din(wire_in[26]), .dout(wire_out[26]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_27(.wen(wen_wire), .en(1'b1), .addr(addr_wire_27), .din(wire_in[27]), .dout(wire_out[27]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_28(.wen(wen_wire), .en(1'b1), .addr(addr_wire_28), .din(wire_in[28]), .dout(wire_out[28]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_29(.wen(wen_wire), .en(1'b1), .addr(addr_wire_29), .din(wire_in[29]), .dout(wire_out[29]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_30(.wen(wen_wire), .en(1'b1), .addr(addr_wire_30), .din(wire_in[30]), .dout(wire_out[30]), .clk(clk) );

  block_ram_sp #(.DATA_WIDTH(32), .ADDR_WIDTH(7)) 
         ram_inst_31(.wen(wen_wire), .en(1'b1), .addr(addr_wire_31), .din(wire_in[31]), .dout(wire_out[31]), .clk(clk) );
