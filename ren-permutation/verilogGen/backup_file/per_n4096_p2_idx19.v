...
module  mem_addr_gen_dp2_mem0_per19(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  assign ms_word_low_w = counter_in[9:8]; 
  assign ms_word_high_w = counter_in[8:7]; 
    
endmodule                        


module  mem_addr_ctrl_dp2_per19(
in_start,                          
wen_out,                         
out_start,                         
mem_addr_out_0,                         
...
rst                              
  ...
  mem_addr_gen_dp2_mem0_per19 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter)); 

  assign mem_addr_out_w_h = mem_addr_out_w[10:10];        
...
rst                              
  ...
  mem_addr_ctrl_dp2_per19 addr_gen_inst(.in_start(in_start), .wen_out(wen_wire), .out_start(out_start_wire), .mem_addr_out_0(addr_wire_0), .mem_addr_out_1(addr_wire_1), .clk(clk), .rst(rst));
