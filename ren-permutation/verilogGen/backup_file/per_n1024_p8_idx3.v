...
rst                              
  ...
  wire [6:0] counter_out_w;
  counter_128 switch_ctrl(.in_start(in_start_stage2), .counter_out(counter_out_w), .clk(clk), .rst(rst));
...
module  mem_addr_gen_dp8_mem0_per3(
counter_in,                              
clk,                             
rst,                             
addr_out                            
...
rst                              
  ...
  mem_addr_gen_dp8_mem0_per3 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter)); 
