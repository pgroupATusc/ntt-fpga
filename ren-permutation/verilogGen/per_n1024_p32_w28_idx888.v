...
module switches_stage_st2_888_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st3_888_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st4_888_L(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  assign wire_ctrl_stage0[4] = counter_w[4]; 
  assign wire_ctrl_stage0[5] = counter_w[4]; 
  assign wire_ctrl_stage0[6] = counter_w[4]; 
  assign wire_ctrl_stage0[7] = counter_w[4]; 
  assign wire_ctrl_stage0[8] = counter_w[4]; 
  assign wire_ctrl_stage0[9] = counter_w[4]; 
  assign wire_ctrl_stage0[10] = counter_w[4]; 
  assign wire_ctrl_stage0[11] = counter_w[4]; 
  assign wire_ctrl_stage0[12] = counter_w[4]; 
  assign wire_ctrl_stage0[13] = counter_w[4]; 
  assign wire_ctrl_stage0[14] = counter_w[4]; 
  assign wire_ctrl_stage0[15] = counter_w[4]; 
  ...
  assign wire_ctrl_stage1[4] = counter_w[3]; 
  assign wire_ctrl_stage1[5] = counter_w[3]; 
  assign wire_ctrl_stage1[6] = counter_w[3]; 
  assign wire_ctrl_stage1[7] = counter_w[3]; 
  assign wire_ctrl_stage1[8] = counter_w[3]; 
  assign wire_ctrl_stage1[9] = counter_w[3]; 
  assign wire_ctrl_stage1[10] = counter_w[3]; 
  assign wire_ctrl_stage1[11] = counter_w[3]; 
  assign wire_ctrl_stage1[12] = counter_w[3]; 
  assign wire_ctrl_stage1[13] = counter_w[3]; 
  assign wire_ctrl_stage1[14] = counter_w[3]; 
  assign wire_ctrl_stage1[15] = counter_w[3]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage2[31:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage2[31:0];
  wire [15:0] wire_ctrl_stage2;

  switches_stage_st2_888_L switch_stage_2(
  ...
  assign wire_ctrl_stage2[4] = counter_w[2]; 
  assign wire_ctrl_stage2[5] = counter_w[2]; 
  assign wire_ctrl_stage2[6] = counter_w[2]; 
  assign wire_ctrl_stage2[7] = counter_w[2]; 
  assign wire_ctrl_stage2[8] = counter_w[2]; 
  assign wire_ctrl_stage2[9] = counter_w[2]; 
  assign wire_ctrl_stage2[10] = counter_w[2]; 
  assign wire_ctrl_stage2[11] = counter_w[2]; 
  assign wire_ctrl_stage2[12] = counter_w[2]; 
  assign wire_ctrl_stage2[13] = counter_w[2]; 
  assign wire_ctrl_stage2[14] = counter_w[2]; 
  assign wire_ctrl_stage2[15] = counter_w[2]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage3[31:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage3[31:0];
  wire [15:0] wire_ctrl_stage3;

  switches_stage_st3_888_L switch_stage_3(
  ...
  assign wire_ctrl_stage3[0] = counter_w[1]; 
  assign wire_ctrl_stage3[1] = counter_w[1]; 
  assign wire_ctrl_stage3[2] = counter_w[1]; 
  assign wire_ctrl_stage3[3] = counter_w[1]; 
  assign wire_ctrl_stage3[4] = counter_w[1]; 
  assign wire_ctrl_stage3[5] = counter_w[1]; 
  assign wire_ctrl_stage3[6] = counter_w[1]; 
  assign wire_ctrl_stage3[7] = counter_w[1]; 
  assign wire_ctrl_stage3[8] = counter_w[1]; 
  assign wire_ctrl_stage3[9] = counter_w[1]; 
  assign wire_ctrl_stage3[10] = counter_w[1]; 
  assign wire_ctrl_stage3[11] = counter_w[1]; 
  assign wire_ctrl_stage3[12] = counter_w[1]; 
  assign wire_ctrl_stage3[13] = counter_w[1]; 
  assign wire_ctrl_stage3[14] = counter_w[1]; 
  assign wire_ctrl_stage3[15] = counter_w[1]; 
  wire [DATA_WIDTH-1:0] wire_con_in_stage4[31:0];
  wire [DATA_WIDTH-1:0] wire_con_out_stage4[31:0];
  wire [15:0] wire_ctrl_stage4;

  switches_stage_st4_888_L switch_stage_4(
  ...
  assign wire_ctrl_stage4[0] = counter_w[0]; 
  assign wire_ctrl_stage4[1] = counter_w[0]; 
  assign wire_ctrl_stage4[2] = counter_w[0]; 
  assign wire_ctrl_stage4[3] = counter_w[0]; 
  assign wire_ctrl_stage4[4] = counter_w[0]; 
  assign wire_ctrl_stage4[5] = counter_w[0]; 
  assign wire_ctrl_stage4[6] = counter_w[0]; 
  assign wire_ctrl_stage4[7] = counter_w[0]; 
  assign wire_ctrl_stage4[8] = counter_w[0]; 
  assign wire_ctrl_stage4[9] = counter_w[0]; 
  assign wire_ctrl_stage4[10] = counter_w[0]; 
  assign wire_ctrl_stage4[11] = counter_w[0]; 
  assign wire_ctrl_stage4[12] = counter_w[0]; 
  assign wire_ctrl_stage4[13] = counter_w[0]; 
  assign wire_ctrl_stage4[14] = counter_w[0]; 
  assign wire_ctrl_stage4[15] = counter_w[0]; 
...
module switches_stage_st2_888_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st3_888_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
module switches_stage_st4_888_R(
inData_0,
inData_1,
inData_2,
inData_3,
...
rst                              
  ...
  switches_stage_st4_888_R switch_stage_4(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage4[0] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage4[1] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage4[2] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage4[3] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage4[4] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage4[5] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage4[6] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage4[7] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage4[8] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage4[9] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage4[10] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage4[11] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage4[12] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage4[13] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage4[14] <= counter_w[0]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage4[15] <= counter_w[0]; 
  end                            
  ...
  switches_stage_st3_888_R switch_stage_3(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[0] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[1] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[2] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[3] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[4] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[5] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[6] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[7] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[8] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[9] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[10] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[11] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[12] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[13] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[14] <= counter_w[1]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage3[15] <= counter_w[1]; 
  end                            
  ...
  switches_stage_st2_888_R switch_stage_2(
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[4] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[5] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[6] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[7] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[8] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[9] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[10] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[11] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[12] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[13] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[14] <= counter_w[2]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage2[15] <= counter_w[2]; 
  end                            
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[4] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[5] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[6] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[7] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[8] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[9] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[10] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[11] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[12] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[13] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[14] <= counter_w[3]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage1[15] <= counter_w[3]; 
  end                            
  ...
  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[4] <= counter_w[4]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[5] <= counter_w[4]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[6] <= counter_w[4]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[7] <= counter_w[4]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[8] <= counter_w[4]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[9] <= counter_w[4]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[10] <= counter_w[4]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[11] <= counter_w[4]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[12] <= counter_w[4]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[13] <= counter_w[4]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[14] <= counter_w[4]; 
  end                            

  always@(posedge clk)             
  begin                            
    wire_ctrl_stage0[15] <= counter_w[4]; 
  end                            
...
module  mem_addr_gen_dp32_mem0_per888(
counter_in,                              
clk,                             
rst,                             
addr_out                            
  ...
  wire [4:0] addr_a0;      
  assign addr_out[4:0] = addr_a0[4:0];   
  
  assign addr_a0 = counter_in[4:0]; 
  
endmodule                        


module  mem_addr_ctrl_dp32_per888(
in_start,                          
counter_in,                         
wen_out,                         
out_start,                         
...
rst                              
  ...
  mem_addr_gen_dp32_mem0_per888 top_mem_addr_gen_inst (.clk(clk),.rst(rst),.addr_out(mem_addr_out_w), .counter_in(counter_in)); 
