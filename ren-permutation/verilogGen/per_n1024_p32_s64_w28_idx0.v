...
module ctrl_rom_dp32_st0_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp32_st0_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp32_st0_per0L ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module ctrl_rom_dp32_st1_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp32_st1_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp32_st1_per0L ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module ctrl_rom_dp32_st2_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp32_st2_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp32_st2_per0L ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module ctrl_rom_dp32_st3_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp32_st3_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp32_st3_per0L ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module ctrl_rom_dp32_st4_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp32_st4_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp32_st4_per0L ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
rst                              
  ...
  switch_ctrl_dp32_st0_per0L switch_ctrl_stage_0(.in_start(in_start_stage0),.ctrl_out(wire_ctrl_stage0),.clk(clk), .rst(rst));
  ...
  switch_ctrl_dp32_st1_per0L switch_ctrl_stage_1(.in_start(in_start_stage1),.ctrl_out(wire_ctrl_stage1),.clk(clk), .rst(rst));
  ...
  switch_ctrl_dp32_st2_per0L switch_ctrl_stage_2(.in_start(in_start_stage2),.ctrl_out(wire_ctrl_stage2),.clk(clk), .rst(rst));
  ...
  switch_ctrl_dp32_st3_per0L switch_ctrl_stage_3(.in_start(in_start_stage3),.ctrl_out(wire_ctrl_stage3),.clk(clk), .rst(rst));
  ...
  switch_ctrl_dp32_st4_per0L switch_ctrl_stage_4(.in_start(in_start_stage4),.ctrl_out(wire_ctrl_stage4),.clk(clk), .rst(rst));
...
module ctrl_rom_dp32_st0_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp32_st0_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp32_st0_per0R ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module ctrl_rom_dp32_st1_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp32_st1_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp32_st1_per0R ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module ctrl_rom_dp32_st2_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp32_st2_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp32_st2_per0R ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module ctrl_rom_dp32_st3_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp32_st3_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp32_st3_per0R ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module ctrl_rom_dp32_st4_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module switch_ctrl_dp32_st4_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  ctrl_rom_dp32_st4_per0R ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
rst                              
  ...
  switch_ctrl_dp32_st4_per0R switch_ctrl_stage_4(.in_start(con_in_start_stage4),.ctrl_out(wire_ctrl_stage4),.clk(clk), .rst(rst));
  ...
  switch_ctrl_dp32_st3_per0R switch_ctrl_stage_3(.in_start(con_in_start_stage3),.ctrl_out(wire_ctrl_stage3),.clk(clk), .rst(rst));
  ...
  switch_ctrl_dp32_st2_per0R switch_ctrl_stage_2(.in_start(con_in_start_stage2),.ctrl_out(wire_ctrl_stage2),.clk(clk), .rst(rst));
  ...
  switch_ctrl_dp32_st1_per0R switch_ctrl_stage_1(.in_start(con_in_start_stage1),.ctrl_out(wire_ctrl_stage1),.clk(clk), .rst(rst));
  ...
  switch_ctrl_dp32_st0_per0R switch_ctrl_stage_0(.in_start(con_in_start_stage0),.ctrl_out(wire_ctrl_stage0),.clk(clk), .rst(rst));
...
rst                              
  ...
  addr_rom_dp32_mem0 addr_rom_inst_0(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_0)); 
  addr_rom_dp32_mem1 addr_rom_inst_1(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_1)); 
  addr_rom_dp32_mem2 addr_rom_inst_2(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_2)); 
  addr_rom_dp32_mem3 addr_rom_inst_3(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_3)); 
  addr_rom_dp32_mem4 addr_rom_inst_4(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_4)); 
  addr_rom_dp32_mem5 addr_rom_inst_5(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_5)); 
  addr_rom_dp32_mem6 addr_rom_inst_6(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_6)); 
  addr_rom_dp32_mem7 addr_rom_inst_7(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_7)); 
  addr_rom_dp32_mem8 addr_rom_inst_8(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_8)); 
  addr_rom_dp32_mem9 addr_rom_inst_9(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_9)); 
  addr_rom_dp32_mem10 addr_rom_inst_10(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_10)); 
  addr_rom_dp32_mem11 addr_rom_inst_11(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_11)); 
  addr_rom_dp32_mem12 addr_rom_inst_12(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_12)); 
  addr_rom_dp32_mem13 addr_rom_inst_13(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_13)); 
  addr_rom_dp32_mem14 addr_rom_inst_14(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_14)); 
  addr_rom_dp32_mem15 addr_rom_inst_15(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_15)); 
  addr_rom_dp32_mem16 addr_rom_inst_16(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_16)); 
  addr_rom_dp32_mem17 addr_rom_inst_17(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_17)); 
  addr_rom_dp32_mem18 addr_rom_inst_18(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_18)); 
  addr_rom_dp32_mem19 addr_rom_inst_19(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_19)); 
  addr_rom_dp32_mem20 addr_rom_inst_20(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_20)); 
  addr_rom_dp32_mem21 addr_rom_inst_21(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_21)); 
  addr_rom_dp32_mem22 addr_rom_inst_22(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_22)); 
  addr_rom_dp32_mem23 addr_rom_inst_23(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_23)); 
  addr_rom_dp32_mem24 addr_rom_inst_24(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_24)); 
  addr_rom_dp32_mem25 addr_rom_inst_25(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_25)); 
  addr_rom_dp32_mem26 addr_rom_inst_26(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_26)); 
  addr_rom_dp32_mem27 addr_rom_inst_27(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_27)); 
  addr_rom_dp32_mem28 addr_rom_inst_28(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_28)); 
  addr_rom_dp32_mem29 addr_rom_inst_29(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_29)); 
  addr_rom_dp32_mem30 addr_rom_inst_30(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_30)); 
  addr_rom_dp32_mem31 addr_rom_inst_31(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_31)); 
...
rst                              
  ...
  addr_rom_ctrl_dp32_per0 addr_gen_inst(.in_start(in_start), .counter_in(counter_in), .wen_out(wen_wire), .out_start(out_start_wire), .rom_out_0(addr_w_wire_0), .rom_out_1(addr_w_wire_1), .rom_out_2(addr_w_wire_2), .rom_out_3(addr_w_wire_3), .rom_out_4(addr_w_wire_4), .rom_out_5(addr_w_wire_5), .rom_out_6(addr_w_wire_6), .rom_out_7(addr_w_wire_7), .rom_out_8(addr_w_wire_8), .rom_out_9(addr_w_wire_9), .rom_out_10(addr_w_wire_10), .rom_out_11(addr_w_wire_11), .rom_out_12(addr_w_wire_12), .rom_out_13(addr_w_wire_13), .rom_out_14(addr_w_wire_14), .rom_out_15(addr_w_wire_15), .rom_out_16(addr_w_wire_16), .rom_out_17(addr_w_wire_17), .rom_out_18(addr_w_wire_18), .rom_out_19(addr_w_wire_19), .rom_out_20(addr_w_wire_20), .rom_out_21(addr_w_wire_21), .rom_out_22(addr_w_wire_22), .rom_out_23(addr_w_wire_23), .rom_out_24(addr_w_wire_24), .rom_out_25(addr_w_wire_25), .rom_out_26(addr_w_wire_26), .rom_out_27(addr_w_wire_27), .rom_out_28(addr_w_wire_28), .rom_out_29(addr_w_wire_29), .rom_out_30(addr_w_wire_30), .rom_out_31(addr_w_wire_31), .clk(clk), .rst(rst));
