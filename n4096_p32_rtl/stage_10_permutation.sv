...
rst                              
  ...
  s10_ctrl_rom_dp32_st0_per0L s10_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
rst                              
  ...
  s10_ctrl_rom_dp32_st1_per0L s10_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
rst                              
  ...
  s10_ctrl_rom_dp32_st2_per0L s10_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
rst                              
  ...
  s10_ctrl_rom_dp32_st3_per0L s10_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
rst                              
  ...
  s10_ctrl_rom_dp32_st4_per0L s10_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
rst                              
  ...
  s10_switch_ctrl_dp32_st0_per0L s10_switch_ctrl_stage_0(.in_start(in_start_stage0),.ctrl_out(wire_ctrl_stage0),.clk(clk), .rst(rst));
  ...
  s10_switch_ctrl_dp32_st1_per0L s10_switch_ctrl_stage_1(.in_start(in_start_stage1),.ctrl_out(wire_ctrl_stage1),.clk(clk), .rst(rst));
  ...
  s10_switch_ctrl_dp32_st2_per0L s10_switch_ctrl_stage_2(.in_start(in_start_stage2),.ctrl_out(wire_ctrl_stage2),.clk(clk), .rst(rst));
  ...
  s10_switch_ctrl_dp32_st3_per0L s10_switch_ctrl_stage_3(.in_start(in_start_stage3),.ctrl_out(wire_ctrl_stage3),.clk(clk), .rst(rst));
  ...
  s10_switch_ctrl_dp32_st4_per0L s10_switch_ctrl_stage_4(.in_start(in_start_stage4),.ctrl_out(wire_ctrl_stage4),.clk(clk), .rst(rst));
...
rst                              
  ...
  s10_ctrl_rom_dp32_st0_per0R s10_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
rst                              
  ...
  s10_ctrl_rom_dp32_st1_per0R s10_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
rst                              
  ...
  s10_ctrl_rom_dp32_st2_per0R s10_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
rst                              
  ...
  s10_ctrl_rom_dp32_st3_per0R s10_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
rst                              
  ...
  s10_ctrl_rom_dp32_st4_per0R s10_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
rst                              
  ...
  s10_switch_ctrl_dp32_st4_per0R s10_switch_ctrl_stage_4(.in_start(con_in_start_stage4),.ctrl_out(wire_ctrl_stage4),.clk(clk), .rst(rst));
  ...
  s10_switch_ctrl_dp32_st3_per0R s10_switch_ctrl_stage_3(.in_start(con_in_start_stage3),.ctrl_out(wire_ctrl_stage3),.clk(clk), .rst(rst));
  ...
  s10_switch_ctrl_dp32_st2_per0R s10_switch_ctrl_stage_2(.in_start(con_in_start_stage2),.ctrl_out(wire_ctrl_stage2),.clk(clk), .rst(rst));
  ...
  s10_switch_ctrl_dp32_st1_per0R s10_switch_ctrl_stage_1(.in_start(con_in_start_stage1),.ctrl_out(wire_ctrl_stage1),.clk(clk), .rst(rst));
  ...
  s10_switch_ctrl_dp32_st0_per0R s10_switch_ctrl_stage_0(.in_start(con_in_start_stage0),.ctrl_out(wire_ctrl_stage0),.clk(clk), .rst(rst));
