...
module s8_ctrl_rom_dp32_st0_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module s8_switch_ctrl_dp32_st0_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s8_ctrl_rom_dp32_st0_per0L s8_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module s8_ctrl_rom_dp32_st1_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module s8_switch_ctrl_dp32_st1_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s8_ctrl_rom_dp32_st1_per0L s8_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module s8_ctrl_rom_dp32_st2_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module s8_switch_ctrl_dp32_st2_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s8_ctrl_rom_dp32_st2_per0L s8_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module s8_ctrl_rom_dp32_st3_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module s8_switch_ctrl_dp32_st3_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s8_ctrl_rom_dp32_st3_per0L s8_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module s8_ctrl_rom_dp32_st4_per0L(
en,                              
clk,                             
rst,                             
addr,                            
...
module s8_switch_ctrl_dp32_st4_per0L(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s8_ctrl_rom_dp32_st4_per0L s8_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
rst                              
  ...
  s8_wireCon_dp32_st0_L wire_stage_0(
  ...
  s8_switch_ctrl_dp32_st0_per0L s8_switch_ctrl_stage_0(.in_start(in_start_stage0),.ctrl_out(wire_ctrl_stage0),.clk(clk), .rst(rst));
  ...
  s8_wireCon_dp32_st1_L wire_stage_1(
  ...
  s8_switch_ctrl_dp32_st1_per0L s8_switch_ctrl_stage_1(.in_start(in_start_stage1),.ctrl_out(wire_ctrl_stage1),.clk(clk), .rst(rst));
  ...
  s8_wireCon_dp32_st2_L wire_stage_2(
  ...
  s8_switch_ctrl_dp32_st2_per0L s8_switch_ctrl_stage_2(.in_start(in_start_stage2),.ctrl_out(wire_ctrl_stage2),.clk(clk), .rst(rst));
  ...
  s8_wireCon_dp32_st3_L wire_stage_3(
  ...
  s8_switch_ctrl_dp32_st3_per0L s8_switch_ctrl_stage_3(.in_start(in_start_stage3),.ctrl_out(wire_ctrl_stage3),.clk(clk), .rst(rst));
  ...
  s8_wireCon_dp32_st4_L wire_stage_4(
  ...
  s8_switch_ctrl_dp32_st4_per0L s8_switch_ctrl_stage_4(.in_start(in_start_stage4),.ctrl_out(wire_ctrl_stage4),.clk(clk), .rst(rst));
...
module s8_ctrl_rom_dp32_st0_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module s8_switch_ctrl_dp32_st0_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s8_ctrl_rom_dp32_st0_per0R s8_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module s8_ctrl_rom_dp32_st1_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module s8_switch_ctrl_dp32_st1_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s8_ctrl_rom_dp32_st1_per0R s8_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module s8_ctrl_rom_dp32_st2_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module s8_switch_ctrl_dp32_st2_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s8_ctrl_rom_dp32_st2_per0R s8_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module s8_ctrl_rom_dp32_st3_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module s8_switch_ctrl_dp32_st3_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s8_ctrl_rom_dp32_st3_per0R s8_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
module s8_ctrl_rom_dp32_st4_per0R(
en,                              
clk,                             
rst,                             
addr,                            
...
module s8_switch_ctrl_dp32_st4_per0R(
in_start,                          
ctrl_out,                        
clk,                             
rst                              
  ...
  s8_ctrl_rom_dp32_st4_per0R s8_ctrl_rom_inst(.en(1'b1),.clk(clk),.rst(rst),.addr(addr),.data(ctrl_out)); 
...
rst                              
  ...
  s8_wireCon_dp32_st4_R wire_stage_4(
        .inData_0(wireIn[0]), .inData_1(wireIn[1]), .inData_2(wireIn[2]), .inData_3(wireIn[3]), .inData_4(wireIn[4]), .inData_5(wireIn[5]), .inData_6(wireIn[6]), .inData_7(wireIn[7]), .inData_8(wireIn[8]), .inData_9(wireIn[9]), .inData_10(wireIn[10]), .inData_11(wireIn[11]), .inData_12(wireIn[12]), .inData_13(wireIn[13]), .inData_14(wireIn[14]), .inData_15(wireIn[15]), .inData_16(wireIn[16]), .inData_17(wireIn[17]), .inData_18(wireIn[18]), .inData_19(wireIn[19]), .inData_20(wireIn[20]), .inData_21(wireIn[21]), .inData_22(wireIn[22]), .inData_23(wireIn[23]), .inData_24(wireIn[24]), .inData_25(wireIn[25]), .inData_26(wireIn[26]), .inData_27(wireIn[27]), .inData_28(wireIn[28]), .inData_29(wireIn[29]), .inData_30(wireIn[30]), .inData_31(wireIn[31]), 
  ...
  s8_switch_ctrl_dp32_st4_per0R s8_switch_ctrl_stage_4(.in_start(con_in_start_stage4),.ctrl_out(wire_ctrl_stage4),.clk(clk), .rst(rst));
  ...
  s8_wireCon_dp32_st3_R wire_stage_3(
  ...
  s8_switch_ctrl_dp32_st3_per0R s8_switch_ctrl_stage_3(.in_start(con_in_start_stage3),.ctrl_out(wire_ctrl_stage3),.clk(clk), .rst(rst));
  ...
  s8_wireCon_dp32_st2_R wire_stage_2(
  ...
  s8_switch_ctrl_dp32_st2_per0R s8_switch_ctrl_stage_2(.in_start(con_in_start_stage2),.ctrl_out(wire_ctrl_stage2),.clk(clk), .rst(rst));
  ...
  s8_wireCon_dp32_st1_R wire_stage_1(
  ...
  s8_switch_ctrl_dp32_st1_per0R s8_switch_ctrl_stage_1(.in_start(con_in_start_stage1),.ctrl_out(wire_ctrl_stage1),.clk(clk), .rst(rst));
  ...
  s8_wireCon_dp32_st0_R wire_stage_0(
  ...
  s8_switch_ctrl_dp32_st0_per0R s8_switch_ctrl_stage_0(.in_start(con_in_start_stage0),.ctrl_out(wire_ctrl_stage0),.clk(clk), .rst(rst));
...
module  s8_addr_rom_ctrl_dp32_per0(
in_start,                          
wen_out,                         
out_start,                         
rom_out_0,                         
...
rst                              
  ...
  s8_addr_rom_dp32_mem0 addr_rom_inst_0(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_0)); 
  s8_addr_rom_dp32_mem1 addr_rom_inst_1(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_1)); 
  s8_addr_rom_dp32_mem2 addr_rom_inst_2(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_2)); 
  s8_addr_rom_dp32_mem3 addr_rom_inst_3(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_3)); 
  s8_addr_rom_dp32_mem4 addr_rom_inst_4(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_4)); 
  s8_addr_rom_dp32_mem5 addr_rom_inst_5(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_5)); 
  s8_addr_rom_dp32_mem6 addr_rom_inst_6(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_6)); 
  s8_addr_rom_dp32_mem7 addr_rom_inst_7(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_7)); 
  s8_addr_rom_dp32_mem8 addr_rom_inst_8(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_8)); 
  s8_addr_rom_dp32_mem9 addr_rom_inst_9(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_9)); 
  s8_addr_rom_dp32_mem10 addr_rom_inst_10(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_10)); 
  s8_addr_rom_dp32_mem11 addr_rom_inst_11(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_11)); 
  s8_addr_rom_dp32_mem12 addr_rom_inst_12(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_12)); 
  s8_addr_rom_dp32_mem13 addr_rom_inst_13(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_13)); 
  s8_addr_rom_dp32_mem14 addr_rom_inst_14(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_14)); 
  s8_addr_rom_dp32_mem15 addr_rom_inst_15(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_15)); 
  s8_addr_rom_dp32_mem16 addr_rom_inst_16(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_16)); 
  s8_addr_rom_dp32_mem17 addr_rom_inst_17(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_17)); 
  s8_addr_rom_dp32_mem18 addr_rom_inst_18(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_18)); 
  s8_addr_rom_dp32_mem19 addr_rom_inst_19(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_19)); 
  s8_addr_rom_dp32_mem20 addr_rom_inst_20(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_20)); 
  s8_addr_rom_dp32_mem21 addr_rom_inst_21(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_21)); 
  s8_addr_rom_dp32_mem22 addr_rom_inst_22(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_22)); 
  s8_addr_rom_dp32_mem23 addr_rom_inst_23(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_23)); 
  s8_addr_rom_dp32_mem24 addr_rom_inst_24(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_24)); 
  s8_addr_rom_dp32_mem25 addr_rom_inst_25(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_25)); 
  s8_addr_rom_dp32_mem26 addr_rom_inst_26(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_26)); 
  s8_addr_rom_dp32_mem27 addr_rom_inst_27(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_27)); 
  s8_addr_rom_dp32_mem28 addr_rom_inst_28(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_28)); 
  s8_addr_rom_dp32_mem29 addr_rom_inst_29(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_29)); 
  s8_addr_rom_dp32_mem30 addr_rom_inst_30(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_30)); 
  s8_addr_rom_dp32_mem31 addr_rom_inst_31(.en(1'b1),.clk(clk),.rst(rst),.addr(rom_addr_0),.data(rom_out_31)); 
